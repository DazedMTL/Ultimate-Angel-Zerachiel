    ...
    (function (Consts) {
      ...
      (function (Enums) {
        ...
        (function (TouchInputStatus) {
          ...
          (TouchInputStatus =
            Enums.TouchInputStatus || (Enums.TouchInputStatus = {}))
        );
        var Orientation;
        ...
        (function (DamagePopupTypes) {
          ...
          DamagePopupTypes[(DamagePopupTypes["HpCriticalDamage"] = 17)] =
            "HpCriticalDamage";
          DamagePopupTypes[(DamagePopupTypes["HpRecover"] = 18)] = "HpRecover";
          DamagePopupTypes[(DamagePopupTypes["MpDamage"] = 32)] = "MpDamage";
          DamagePopupTypes[(DamagePopupTypes["MpCriticalDamage"] = 33)] =
            "MpCriticalDamage";
          DamagePopupTypes[(DamagePopupTypes["MpRecover"] = 34)] = "MpRecover";
          DamagePopupTypes[(DamagePopupTypes["TpDamage"] = 48)] = "TpDamage";
          DamagePopupTypes[(DamagePopupTypes["TpCriticalDamage"] = 49)] =
            "TpCriticalDamage";
          DamagePopupTypes[(DamagePopupTypes["TpRecover"] = 50)] = "TpRecover";
          DamagePopupTypes[(DamagePopupTypes["AddState"] = 64)] = "AddState";
          DamagePopupTypes[(DamagePopupTypes["AddPositiveState"] = 65)] =
            "AddPositiveState";
          DamagePopupTypes[(DamagePopupTypes["AddNegativeState"] = 66)] =
            "AddNegativeState";
          DamagePopupTypes[(DamagePopupTypes["RemoveState"] = 80)] =
            "RemoveState";
          DamagePopupTypes[(DamagePopupTypes["RemovePositiveState"] = 81)] =
            "RemovePositiveState";
          DamagePopupTypes[(DamagePopupTypes["RemoveNegativeState"] = 82)] =
            "RemoveNegativeState";
          DamagePopupTypes[(DamagePopupTypes["AddBuff"] = 96)] = "AddBuff";
          DamagePopupTypes[(DamagePopupTypes["AddDebuff"] = 97)] = "AddDebuff";
          DamagePopupTypes[(DamagePopupTypes["RemoveBuff"] = 112)] =
            "RemoveBuff";
          DamagePopupTypes[(DamagePopupTypes["RemoveDebuff"] = 113)] =
            "RemoveDebuff";
          DamagePopupTypes[(DamagePopupTypes["Effective"] = 256)] = "Effective";
          DamagePopupTypes[(DamagePopupTypes["NotEffective"] = 257)] =
            "NotEffective";
        })(
          (DamagePopupTypes =
            Enums.DamagePopupTypes || (Enums.DamagePopupTypes = {}))
        );
        var ConditionalBattlerGraphicKind;
        (function (ConditionalBattlerGraphicKind) {
          ConditionalBattlerGraphicKind[
            (ConditionalBattlerGraphicKind["state"] = 128)
          ] = "state";
          ConditionalBattlerGraphicKind[
            (ConditionalBattlerGraphicKind["crisis"] = 256)
          ] = "crisis";
          ConditionalBattlerGraphicKind[
            (ConditionalBattlerGraphicKind["command"] = 512)
          ] = "command";
          ConditionalBattlerGraphicKind[
            (ConditionalBattlerGraphicKind["ready"] = 513)
          ] = "ready";
          ConditionalBattlerGraphicKind[
            (ConditionalBattlerGraphicKind["guard"] = 514)
          ] = "guard";
          ConditionalBattlerGraphicKind[
            (ConditionalBattlerGraphicKind["chanting"] = 515)
          ] = "chanting";
          ConditionalBattlerGraphicKind[
            (ConditionalBattlerGraphicKind["skill"] = 1024)
          ] = "skill";
          ConditionalBattlerGraphicKind[
            (ConditionalBattlerGraphicKind["item"] = 1025)
          ] = "item";
          ConditionalBattlerGraphicKind[
            (ConditionalBattlerGraphicKind["damage"] = 2048)
          ] = "damage";
          ConditionalBattlerGraphicKind[
            (ConditionalBattlerGraphicKind["victory"] = 2049)
          ] = "victory";
          ConditionalBattlerGraphicKind[
            (ConditionalBattlerGraphicKind["dead"] = 4096)
          ] = "dead";
        })(
          (ConditionalBattlerGraphicKind =
            Enums.ConditionalBattlerGraphicKind ||
            (Enums.ConditionalBattlerGraphicKind = {}))
        );
        var Languages;
        (function (Languages) {
  ...
  (function (Core) {
    ...
    (function (PluginParameterLoader) {
      function overwriteWithPluginParameters(pluginName, dst) {
        ...
        _enumerateSettingKeys("", dst).forEach(function (x) {
          return _overwrite(dst, params, paramsKeys, x);
        });
      }
      PluginParameterLoader.overwriteWithPluginParameters =
        overwriteWithPluginParameters;
      function _enumerateSettingKeys(base, object) {
        ...
        keys
          ...
          .forEach(function (x) {
            ...
            k.map(function (y) {
              return base + (base.length > 0 ? "." : "") + y;
            }).forEach(function (y) {
              return settingKeys.push(y);
            });
          });
        return settingKeys;
      }
      function _overwrite(dst, params, paramsKeys, key) {
        ...
        var setting = dst;
        var path = key.split(".");
        path.slice(0, path.length - 1).forEach(function (x) {
          return (setting = setting[x]);
        });
      ...
      (PluginParameterLoader =
        Core.PluginParameterLoader || (Core.PluginParameterLoader = {}))
    );
  })((Core = BD.Core || (BD.Core = {})));
})(BD || (BD = {}));
  ...
  (function (Core) {
    ...
    (function (Settings) {
      var _defaultColors = [
        ...
        {
          bodyColor: "rgba(160,250,108,1.0)",
          outlineColor: "rgba(0,72,32,1.0)",
        },
        { bodyColor: "rgba(192,96,232,1.0)", outlineColor: "rgba(0,0,0,1.0)" },
        {
          bodyColor: "rgba(172,232,250,1.0)",
          outlineColor: "rgba(40,64,168,1.0)",
        },
        {
          bodyColor: "rgba(224,224,72,1.0)",
          outlineColor: "rgba(0,80,80,1.0)",
        },
        {
          bodyColor: "rgba(224,224,72,1.0)",
          outlineColor: "rgba(0,80,80,1.0)",
        },
        {
          ...
          outlineColor: "rgba(48,92,224,1.0)",
        },
        {
          bodyColor: "rgba(220,214,208,1.0)",
          outlineColor: "rgba(64,64,64,1.0)",
        },
        {
          bodyColor: "rgba(248,242,96,1.0)",
          outlineColor: "rgba(200,28,32,1.0)",
        },
        {
          bodyColor: "rgba(224,224,224,1.0)",
          outlineColor: "rgba(64,64,64,0.5)",
        },
        {
          bodyColor: "rgba(255,255,255,1.0)",
          outlineColor: "rgba(144,108,16,1.0)",
        },
        {
          bodyColor: "rgba(255,255,255,1.0)",
          outlineColor: "rgba(48,116,132,1.0)",
        },
        {
          bodyColor: "rgba(255,255,255,1.0)",
          outlineColor: "rgba(136,64,120,1.0)",
        },
      ];
      ...
      function loadSettingsJson() {
        ...
        Core.PluginParameterLoader.overwriteWithPluginParameters(
          "XPStyleBattleMV",
          _settings
        );
      }
...
(function (BD) {
  ...
  (function (Core) {
    ...
    (function (StandardTheme) {
      ...
      function overwrite() {
        BD.Core.PluginParameterLoader.overwriteWithPluginParameters(
          "XPB-StandardTheme",
          params
        );
      }
      ...
      function create() {
        return root(
          actorAreaBackground(),
          partyStatusContainer(background()),
          partyStatusContainer(battler()),
          partyStatusContainer(
            statusBackground(),
            hpContainer(hpBackground(), hpGauge(), hpSymbol(), hpNumber()),
            mpContainer(mpBackground(), mpGauge(), mpSymbol(), mpNumber()),
            tpContainer(tpBackground(), tpGauge(), tpSymbol(), tpNumber()),
            stateContainer(stateBackground(), stateIcon(), stateSymbol()),
            actorName()
          )
        );
      }
  ...
  (function (Core) {
    ...
    (function (Utils) {
      ...
      (function (BattlerGraphicManager) {
        ...
        function createConditionalBattlerGraphic(
          fileNameWithFaceIndex,
          kind,
          idOrTag,
          priority
        ) {
        ...
        BattlerGraphicManager.createConditionalBattlerGraphic =
          createConditionalBattlerGraphic;
        ...
        function determineCandidate(actor) {
          ...
          if (candidates.length === 0) {
            ...
            return candidates.reduce(function (a, b) {
              return a.condition.priority > b.condition.priority ? a : b;
            });
          }
        }
        ...
        function _enemyBattlerGraphic(battler) {
          ...
          if ($gameSystem.isSideView()) {
            bitmap = ImageManager.loadSvEnemy(
              battler.battlerName(),
              battler.battlerHue()
            );
          } else {
        ...
        function _checkStateCondition(a, c) {
          ...
          if (typeof idOrTag === "string") {
            var f = a.states().find(function (y) {
              return y.meta[idOrTag];
            });
            if (f) {
              return true;
            }
          } else if (
            a._states.contains(idOrTag) ||
            (a._states.length > 0 && idOrTag === 0)
          ) {
            return true;
          }
          return false;
        ...
        function _checkActionConditionCore(a, c, kindCheck) {
          ...
          if (
            a._motionType !== "victory" &&
            BattleManager._subject === a &&
            action &&
            kindCheck(action)
          ) {
            var idOrTag = c.condition.idOrTag;
        ...
        function _checkSkillCondition(a, c) {
          return _checkActionConditionCore(a, c, function (x) {
            return x.isSkill();
          });
        }
        ...
        function _checkDeadCondition(a, c) {
          if (
            Core.Settings.enableSideVidwBattler() &&
            a._motionType !== "damage" &&
            a.isDead()
          ) {
            return true;
          } else if (a.isDead()) {
        ...
        (BattlerGraphicManager =
          Utils.BattlerGraphicManager || (Utils.BattlerGraphicManager = {}))
      );
    ...
    (function (RPGExtension) {
      ...
      function getConditionalBattlerGraphicsRaw(battler) {
        ...
        return strings.map(function (x) {
          var args = x.split(",").map(function (y) {
            return y.trim();
          });
      ...
      RPGExtension.getConditionalBattlerGraphicsRaw =
        getConditionalBattlerGraphicsRaw;
...
(function () {
  ...
  Sprite.prototype.findFamily = function (func, breakFunc) {
    ...
    return top.flatten().find(function (x) {
      return func(x);
    });
  };
})();
    ...
    (function (Utils) {
      ...
      (function (PluginCommand) {
        function execute(command, args) {
          ...
          var key = Object.keys(BD.Core.Utils.PluginCommand).find(function (x) {
            return x === lowCommand;
          });
          if (!key) {
            return;
...
(function () {
  var _bdc_Game_Interpreter_pluginCommand =
...
(function (BD) {
  ...
  (function (CMD) {
    ...
    function setBG(type, idOrIndex, fileNameWithFaceIndex) {
      if (fileNameWithFaceIndex === void 0) {
        fileNameWithFaceIndex = null;
      }
    ...
    function setBattlerGraphic(type, idOrIndex, fileNameWithFaceIndex) {
      ...
      var bg = BattlerGraphicManager.createBattlerGraphic(
        fileNameWithFaceIndex
      );
    ...
    CMD.setCBG = setCBG;
    function setConditionBattlerGraphic(
      type,
      idOrIndex,
      fileNameWithFaceIndex,
      kind,
      ...
      var prio = priority || conditionKind;
      actor.setConditionalBattlerGraphics(
        bg.fileName,
        bg.faceIndex,
        kind,
        idOrTag,
  ...
  (function (Core) {
    ...
    (function (Property) {
      var PropertyChanged = (function () {
        ...
        PropertyChanged.prototype.addPropertyChanged = function (
          type,
          listener,
          thisArg
        ) {
        ...
        PropertyChanged.prototype.containsCallback = function (
          callbacks,
          callback
        ) {
    ...
    (function (Property) {
      ...
      (function (PropertyUtility) {
        ...
        (function (definitions) {
          ...
          definitions.type = new pd({
            key: "type",
            type: "objType",
            defaultValue: "Type",
          });
          definitions.name = new pd({
            key: "name",
            type: "String",
            defaultValue: "Name",
          });
          ...
          definitions.visible = new pd({
            key: "visible",
            type: "Boolean",
            defaultValue: true,
          });
          definitions.width = new pd({
            key: "width",
            type: "Number",
            defaultValue: 128,
          });
          definitions.height = new pd({
            key: "height",
            type: "Number",
            defaultValue: 128,
          });
          definitions.maxWidth = new pd({
            key: "maxWidth",
            type: "Number",
            defaultValue: 128,
          });
          definitions.fileName = new pd({
            key: "fileName",
            type: "String",
            defaultValue: "''",
          });
          definitions.pattern = new pd({
            key: "pattern",
            type: "Number",
            defaultValue: 0,
          });
          definitions.maxPattern = new pd({
            key: "maxPattern",
            type: "Number",
            defaultValue: 1,
          });
          definitions.value = new pd({
            key: "value",
            type: "Number",
            defaultValue: 0,
          });
          definitions.minValue = new pd({
            key: "minValue",
            type: "Number",
            defaultValue: -999999,
          });
          definitions.maxValue = new pd({
            key: "maxValue",
            type: "Number",
            defaultValue: 999999,
          });
          definitions.digits = new pd({
            key: "digits",
            type: "Number",
            defaultValue: 4,
          });
          definitions.zeroSuppress = new pd({
            key: "zeroSuppress",
            type: "Boolean",
            defaultValue: true,
          });
          definitions.spacing = new pd({
            key: "spacing",
            type: "Number",
            defaultValue: 0,
          });
          definitions.horizontalSpacing = new pd({
            key: "horizontalSpacing",
            type: "Number",
            defaultValue: 0,
          });
          definitions.verticalSpacing = new pd({
            key: "verticalSpacing",
            type: "Number",
            defaultValue: 0,
          });
          definitions.animationSpeed = new pd({
            key: "animationSpeed",
            type: "Number",
            defaultValue: 8,
          });
          definitions.horizontalAlignment = new pd({
            key: "horizontalAlignment",
            type: "Number",
            defaultValue: 0,
          });
          definitions.verticalAlignment = new pd({
            key: "verticalAlignment",
            type: "Number",
            defaultValue: 0,
          });
          definitions.orientation = new pd({
            key: "orientation",
            type: "Number",
            defaultValue: 0,
          });
          definitions.actorStatusWidth = new pd({
            key: "actorStatusWidth",
            type: "Number",
            defaultValue: 128,
          });
          definitions.actorStatusHeight = new pd({
            key: "actorStatusHeight",
            type: "Number",
            defaultValue: 128,
          });
          definitions.maxRows = new pd({
            key: "maxRows",
            type: "Number",
            defaultValue: 4,
          });
          definitions.maxLines = new pd({
            key: "maxLines",
            type: "Number",
            defaultValue: 1,
          });
          definitions.startAngle = new pd({
            key: "startAngle",
            type: "Number",
            defaultValue: 0,
          });
          definitions.endAngle = new pd({
            key: "endAngle",
            type: "Number",
            defaultValue: 359,
          });
          definitions.radius = new pd({
            key: "radius",
            type: "Number",
            defaultValue: 32,
          });
          definitions.lineWidth = new pd({
            key: "lineWidth",
            type: "Number",
            defaultValue: 24,
          });
          definitions.zoom = new pd({
            key: "zoom",
            type: "Number",
            defaultValue: 100,
          });
          definitions.zoomX = new pd({
            key: "zoomX",
            type: "Number",
            defaultValue: 100,
          });
          definitions.zoomY = new pd({
            key: "zoomY",
            type: "Number",
            defaultValue: 100,
          });
          definitions.overlayOffsetX = new pd({
            key: "overlayOffsetX",
            type: "Number",
            defaultValue: 0,
          });
          definitions.overlayOffsetY = new pd({
            key: "overlayOffsetY",
            type: "Number",
            defaultValue: 0,
          });
          definitions.isOverlayOnBottom = new pd({
            key: "isOverlayOnBottom",
            type: "Boolean",
            defaultValue: false,
          });
          definitions.skewAngleX = new pd({
            key: "skewAngleX",
            type: "Number",
            defaultValue: 0,
          });
          definitions.skewAngleY = new pd({
            key: "skewAngleY",
            type: "Number",
            defaultValue: 0,
          });
          definitions.rotation = new pd({
            key: "rotation",
            type: "Number",
            defaultValue: 0,
          });
          definitions.opacity = new pd({
            key: "opacity",
            type: "Number",
            defaultValue: 255,
          });
          definitions.blendMode = new pd({
            key: "blendMode",
            type: "Number",
            defaultValue: 0,
          });
          definitions.text = new pd({
            key: "text",
            type: "String",
            defaultValue: "'Text'",
          });
          definitions.color = new pd({
            key: "color",
            type: "String",
            defaultValue: "'Green'",
          });
          definitions.outlineColor = new pd({
            key: "outlineColor",
            type: "String",
            defaultValue: "'Blue'",
          });
          definitions.outlineWidth = new pd({
            key: "outlineWidth",
            type: "Number",
            defaultValue: 4,
          });
          definitions.fontSize = new pd({
            key: "fontSize",
            type: "Number",
            defaultValue: 28,
          });
          definitions.fontFace = new pd({
            key: "fontFace",
            type: "String",
            defaultValue: "'GameFont'",
          });
          definitions.fontItalic = new pd({
            key: "fontItalic",
            type: "Boolean",
            defaultValue: false,
          });
          definitions.fillColor = new pd({
            key: "fillColor",
            type: "String",
            defaultValue: "'Green'",
          });
          definitions.gradientColor = new pd({
            key: "gradientColor",
            type: "String",
            defaultValue: "'Yellow'",
          });
          definitions.isGradient = new pd({
            key: "isGradient",
            type: "Boolean",
            defaultValue: true,
          });
          definitions.isVertical = new pd({
            key: "isVertical",
            type: "Boolean",
            defaultValue: false,
          });
          definitions.isBricks = new pd({
            key: "isBricks",
            type: "Boolean",
            defaultValue: false,
          });
          definitions.maxStates = new pd({
            key: "maxStates",
            type: "Number",
            defaultValue: 1,
          });
          definitions.stateIconSize = new pd({
            key: "stateIconSize",
            type: "Number",
            defaultValue: 32,
          });
          definitions.maskImage = new pd({
            key: "maskImage",
            type: "String",
            defaultValue: "''",
          });
          definitions.maskImageX = new pd({
            key: "maskImageX",
            type: "Number",
            defaultValue: 0,
          });
          definitions.maskImageY = new pd({
            key: "maskImageY",
            type: "Number",
            defaultValue: 0,
          });
          definitions.relatedObjects = new pd({
            key: "relatedObjects",
            type: "String",
            defaultValue: "''",
          });
          ...
          (definitions =
            PropertyUtility.definitions || (PropertyUtility.definitions = {}))
        );
        function make(propData) {
          if (BD.Core.Manager.isStudioMode()) {
            var p = new BD.Studio.Property.Property(
              propData.key,
              propData.type,
        ...
        function safetyMakeFunction(key, value, context) {
          ...
          try {
            ...
            return function () {
              return PropertyUtility.definitions[key].defaultValue;
            };
          }
        }
        ...
        (PropertyUtility =
          Property.PropertyUtility || (Property.PropertyUtility = {}))
      );
    })((Property = Core.Property || (Core.Property = {})));
  })((Core = BD.Core || (BD.Core = {})));
})(BD || (BD = {}));
...
(function () {
  ...
  var _bdc_Sprite_Animation_updatePosition =
  ...
  Sprite_Animation.prototype._updatePositionForXPStyleBattler = function () {
    if (this._animation.position === 3) {
      ...
      this.y =
        -this.containerPoint.y + (Graphics.boxHeight / 6) * 5 + getAdjustY();
    } else {
...
(function () {
  var _bdc_Window_BattleLog_displayAction =
  ...
  Window_BattleLog.prototype.displayAction = function (subject, item) {
    ...
    if (preAnimationId > 0) {
      showAnimationMethods = this._methods.filter(function (x) {
        return x.name === "showAnimation";
      });
      ...
      this._methods = this._methods.filter(function (x) {
        return !showAnimationMethods.contains(x) && x.name !== "wait";
      });
      showAnimationMethods.forEach(function (x) {
        return _this._methods.push(x);
      });
      this.push("wait");
      return;
    }
  ...
  var _bdc_Window_BattleLog_updateWaitMode =
  ...
  (function (Core) {
    ...
    (function (Animation) {
      ...
      (function (StateAnimation) {
        ...
        (StateAnimation =
          Animation.StateAnimation || (Animation.StateAnimation = {}))
      );
...
(function () {
  ...
  Game_Battler.prototype.currentStateAnimationId = function () {
    var stateAnimationIds = this.states()
      ...
      .map(function (x) {
        return BD.Core.RPGExtension.getStateAnimationId(x);
      })
      .filter(function (x) {
        return x > 0;
      });
...
(function () {
  Sprite_Base.prototype.startLoopAnimation = function (
    animation,
    mirror,
    delay
  ) {
    var playing = this._animationSprites
      .filter(function (x) {
        return x instanceof BD.Core.Animation.StateAnimation.LoopAnimation;
      })
      .some(function (x) {
        return x.animation() === animation;
      });
    if (playing) {
      return;
    }
  ...
  Sprite_Base.prototype.isAnimationPlaying = function () {
    var animations = this._animationSprites.filter(function (x) {
      return !(x instanceof BD.Core.Animation.StateAnimation.LoopAnimation);
    });
...
(function () {
  ...
  var _bdc_Sprite_Battler__updateAnimation =
...
(function () {
  ...
  Sprite_Animation.prototype.updateMain = function () {
    if (
      !(this instanceof BD.Core.Animation.StateAnimation.LoopAnimation) &&
      this.isPlaying() &&
      this.isReady()
    ) {
      if (
        BD.Core.BattleSpeed.Utility.isAnimationDelayFastForward() &&
        this._delay > 0
      ) {
        this._delay--;
...
(function () {
  var Settings = BD.Core.Settings.battleSpeed;
  var _bdc_Sprite_Base_isAnimationPlaying =
  ...
  Sprite_Base.prototype.isAnimationPlaying = function () {
    ...
    var endDuration = BD.Core.BattleSpeed.Utility.isFastForward()
      ? skipDuration * 2
      : skipDuration;
    return this._animationSprites
      ...
      .some(function (x) {
        return x.currentFrameIndex() < 2 || x._duration > endDuration;
      });
  };
})();
...
(function () {
  ...
  var _bdc_Window_BattleLog_setWaitMode =
    Window_BattleLog.prototype.setWaitMode;
      ...
      (function (DamagePopupFactory) {
        ...
        function initialize() {
          ...
          Object.keys(DamagePopup.Types)
            .map(function (x) {
              return DamagePopup.Types[x].initializePopup;
            })
            .filter(function (x) {
        ...
        function create(target) {
          ...
          if (result.performCounter) {
            ...
            return popups.filter(function (x) {
              return x !== null;
            });
          }
          ...
          addStates
            .filter(function (x) {
              return (
                x.id !== deathStateId &&
                x.iconIndex !== 0 &&
                !Core.RPGExtension.getHideAddPopup(x)
              );
            })
            .forEach(function (state) {
              var popup = _createPopup(
                _types().addState,
                _createAddState(state),
                name
              );
              popups.push(popup);
            });
          ...
          removeStates
            .filter(function (x) {
              return (
                x.id !== deathStateId &&
                x.iconIndex !== 0 &&
                !Core.RPGExtension.getHideRemovePopup(x)
              );
            })
            .forEach(function (state) {
              var popup = _createPopup(
                _types().removeState,
                _createRemoveState(state),
                name
              );
              popups.push(popup);
            });
        ...
        function _createBuffPopups(target) {
          ...
          result.addedBuffs.forEach(function (id) {
            var popup = _createPopup(
              _types().addBuff,
              _createAddBuff(target, id, false),
              name
            );
            popups.push(popup);
          });
          ...
          result.removedBuffs.forEach(function (id) {
            var popup = _createPopup(
              _types().removeBuff,
              _createRemoveBuff(target, id, false),
              name
            );
            popups.push(popup);
          });
        ...
        function _createAddState(state) {
          ...
          var text = new DamagePopup.Pieces.Text(
            name,
            color,
            _getPopupImageAttributes()
          );
        ...
        function _createAddBuff(target, paramId, debuff) {
          ...
          var color = convertTypeToColorIndex(
            debuff ? PopupTypes.AddDebuff : PopupTypes.AddBuff
          );
        ...
        function _createRemoveBuff(target, paramId, debuff) {
          ...
          var color = convertTypeToColorIndex(
            debuff ? PopupTypes.RemoveDebuff : PopupTypes.RemoveBuff
          );
          var iconId = target.buffIconIndex(debuff ? -1 : 1, paramId);
        ...
        function _createTpChargePopup(target) {
          ...
          if (
            target.isActor() &&
            result.gainSilentTp &&
            result.silentTpDamage !== 0
          ) {
            return _createPopup(
              _types().tpCharge,
              _createTpDamage(target),
              _battlerIdName(target)
            );
          }
          return null;
        }
        ...
        function _createMiss(target) {
          ...
          var miss = new DamagePopup.Pieces.Text(
            _texts().miss,
            color,
            _getPopupImageAttributes()
          );
          return new DamagePopup.Pieces.Base().addPiece(miss);
        }
        function _createEvasion(target) {
          var color = convertTypeToColorIndex(PopupTypes.Evasion);
          var evasion = new DamagePopup.Pieces.Text(
            _texts().evasion,
            color,
            _getPopupImageAttributes()
          );
          return new DamagePopup.Pieces.Base().addPiece(evasion);
        }
        ...
        function _createHpDamage(target) {
          ...
          if (result.hpDamage >= 0) {
            if (result.isEffectiveDamage()) {
              ...
              color = convertTypeToColorIndex(
                result.critical
                  ? PopupTypes.HpCriticalDamage
                  : PopupTypes.HpDamage
              );
            }
          } else {
          ...
          var num = new DamagePopup.Pieces.Digits(
            result.hpDamage,
            color,
            _getPopupImageAttributes()
          );
          var parts = new DamagePopup.Pieces.Base().addPiece(num);
          if (result.hpDamage >= 0) {
        ...
        function _createTpDamage(target) {
          var result = target.result();
          var damage = result.gainSilentTp
            ? result.silentTpDamage
            : result.tpDamage;
          var color;
          var tpText;
          if (damage > 0) {
        ...
        function _createEffective(target, color) {
          var result = target.result();
          if (result.isEffectiveDamage()) {
            return new DamagePopup.Pieces.Text(
              _texts().weakness,
              color,
              _getPopupImageAttributes()
            );
        ...
        (DamagePopupFactory =
          DamagePopup.DamagePopupFactory ||
          (DamagePopup.DamagePopupFactory = {}))
      );
...
(function () {
  ...
  var _bdc_Game_ActionResult_isStatusAffected =
...
(function () {
  ...
  var _bdc_Game_Battler_performReflection =
  ...
  var _bdc_Game_Battler_performSubstitute =
...
(function () {
  ...
  Sprite_Battler.prototype.getPopupLayer = function () {
    if (!this._popupLayer) {
      this._popupLayer = this.findFamily(function (sprite) {
        return sprite instanceof BD.Core.DamagePopup.PopupLayer;
      });
    }
...
(function () {
  var _bdc_Window_BattleLog_displayBuffs =
          ...
          Digits.prototype.setup = function (num, color, attributes) {
            ...
            nums
              ...
              .forEach(function (n) {
                ...
                s.setFrame(
                  _this._getFrameX(n, attributes.widths),
                  attributes.numberHeight * color,
                  attributes.widths[n],
                  attributes.numberHeight
                );
                s.x = _this.pieceWidth;
                _this.pieceWidth += Math.round(
                  attributes.widths[n] * attributes.numberSpacing
                );
                _this.addChild(s);
              });
      ...
      (function (Types) {
        var Overlay = (function (_super) {
          ...
          Overlay.prototype.setup = function (name) {
            ...
            this.children.forEach(function (x) {
              return _this._overlay.addChild(x.clone());
            });
            this._overlay.flatten().forEach(function (x) {
              return (x.blendMode = Graphics.BLEND_ADD);
            });
      ...
      (function (Types) {
        var Rise = (function (_super) {
          ...
          Rise.prototype._isReady = function () {
            ...
            if (
              -this.pieceHeight / 2 >
              currentPopup.y + currentPopup.pieceHeight / 2
            ) {
              return true;
            }
            return false;
        ...
        var Base = (function (_super) {
          ...
          Base.prototype._createSpriteBattleObject = function (obj) {
            try {
              ...
              throw (
                'failed _createSpriteBattleObject "' +
                obj.properties["type"] +
                '"'
              );
            }
          ...
          Base.prototype.endDrag = function (newX, newY) {
            ...
            BD.Studio.Utilities.ObjectController.setProperties(
              name,
              this._properties
            );
          };
          ...
          Base.prototype._valueEvaluation = function (key) {
            ...
            if (func) {
              ...
              this._setPropertyFunctions[key] =
                BD.Core.Property.PropertyUtility.makeFunction(
                  key,
                  value,
                  this.getContext()
                );
      ...
      (function (BattleObjects) {
        var CircleGauge = (function (_super) {
          ...
          CircleGauge.prototype._initializeInternal = function (properties) {
            ...
            this.propertyChanged.addPropertyChanged(
              BattleObjects.defs.fileName.key,
              this._createGauge,
              this
            );
            this.propertyChanged.addPropertyChanged(
              BattleObjects.defs.value.key,
              this._updateRate,
              this
            );
            this.propertyChanged.addPropertyChanged(
              BattleObjects.defs.maxValue.key,
              this._updateRate,
              this
            );
            this._createGauge();
          ...
          CircleGauge.prototype._createCanvasPattern = function () {
            ...
            this._canvasPattern = ctx.createPattern(
              this._sourceBitmap.baseTexture.source,
              "no-repeat"
            );
          };
          CircleGauge.prototype._updateGauge = function () {
            this._displayRate = Core.Utils.Interpolator.smooth(
              this._currentRate,
              this._displayRate,
              this.animationSpeed,
              0.001
          ...
          CircleGauge.prototype._drawGauge = function () {
            ...
            var endAngle = Math.radians(
              this.startAngle -
                (this.startAngle - this.endAngle) * this._displayRate
            );
    ...
    (function (HUD) {
      ...
      (function (BattleObjects) {
        var HorizontalGauge = (function (_super) {
          ...
          HorizontalGauge.prototype._initializeInternal = function (
            properties
          ) {
            this._displayRate = null;
            this._gaugeWidth = 4;
          ...
          HorizontalGauge.prototype._updateGauge = function () {
            ...
            this.setFrame(
              0,
              this._gaugeHeight * this.pattern,
              this._gaugeWidth * this._displayRate,
              this._gaugeHeight
            );
          };
        ...
        var Number = (function (_super) {
          ...
          Number.prototype._updateDisplayValue = function () {
            if (this._displayValue === null) {
              ...
              this._displayValue = Core.Utils.Interpolator.smooth(
                this.value,
                this._displayValue,
                this.animationSpeed,
                0.1
          ...
          Number.prototype._updateDigits = function () {
            ...
            for (var i = 0; i < this.digits; i++) {
              ...
              s.x = this._getNumberPosition(
                i + 1,
                this.zeroSuppress
                  ? Math.min(this.digits, nums.length)
                  : this.digits,
                this._numberWidth
              );
              if (i < nums.length) {
          ...
          Number.prototype._getNumberPosition = function (
            digit,
            length,
            numberWidth
          ) {
            ...
            switch (this.horizontalAlignment) {
              case Core.Consts.Enums.HorizontalAlignment.Left:
                baseX =
                  numberWidth * length + this.horizontalSpacing * (length - 1);
                break;
              case Core.Consts.Enums.HorizontalAlignment.Center:
                var aw =
                  numberWidth * length + this.horizontalSpacing * (length - 1);
                var bw =
                  numberWidth * this.digits +
                  this.horizontalSpacing * (this.digits - 1);
                baseX = bw - (bw - aw) / 2;
                break;
            ...
            return (
              baseX -
              (numberWidth * digit + this.horizontalSpacing * (digit - 1))
            );
          };
          return Number;
        })(BattleObjects.Base);
    ...
    (function (HUD) {
      ...
      (function (BattleObjects) {
        var PartyStatusContainer = (function (_super) {
          ...
          PartyStatusContainer.prototype._initializeInternal = function (
            properties
          ) {
          ...
          PartyStatusContainer.prototype._createBattleObject = function (
            object,
            parent
          ) {
            var _this = this;
            ...
            $gameParty.battleMembers().forEach(function (x) {
              x.initHudParamCache();
              var c = new BattleObjects.Components.BattlerContextContainer(
                x,
                _this
              );
          ...
          PartyStatusContainer.prototype._setPosition = function () {
            ...
            switch (this.orientation) {
              case Core.Consts.Enums.Orientation.Horizontal:
                positions = this._calcAllBattlersPosition(
                  this.maxRows,
                  this.actorStatusWidth,
                  this.horizontalSpacing,
                  this.horizontalAlignment,
                  this.actorStatusHeight,
            ...
            this.children.forEach(function (s, i) {
              ...
              s.b._hitTestRectangle = {
                x: abs.x,
                y: abs.y,
                width: _this.actorStatusWidth,
                height: _this.actorStatusHeight,
              };
            });
          };
          PartyStatusContainer.prototype._calcAllBattlersPosition = function (
            maxMainNum,
            mainAxisSize,
            mainAxisSpacing,
            mainAxisAlignment,
            ...
            if (this.isBricks && eachElementNumbers.length >= 2) {
              ...
              if (last < maxMainNum) {
                eachElementNumbers[eachElementNumbers.length - 1] =
                  maxMainNum - 1;
              }
            }
            var subNum = eachElementNumbers.length;
            var totalSubSize =
              subNum * subAxisSize + subAxisSpacing * (subNum - 1);
            var positions = [];
            eachElementNumbers.forEach(function (mainNum, i) {
              var b = subAxisCalcFunc.call(
                _this,
                i,
                totalSubSize,
                subAxisAlignment
              ...
              var totalMainSize =
                mainNum * mainAxisSize + mainAxisSpacing * (mainNum - 1);
              for (var i_1 = 0; i_1 < mainNum; i_1++) {
                var a = mainAxisCalcFunc.call(
                  _this,
                  i_1,
                  totalMainSize,
                  mainAxisAlignment
          ...
          PartyStatusContainer.prototype._calcActorCoordinate = function (
            alignment,
            pos,
            size,
            actorSize,
          ...
          PartyStatusContainer.prototype._calcActorX = function (
            row,
            totalWidth,
            alignment
          ) {
            return this._calcActorCoordinate(
              alignment,
              row,
              this.width,
              this.actorStatusWidth,
          ...
          PartyStatusContainer.prototype._calcActorY = function (
            line,
            totalHeight,
            alignment
          ) {
          ...
          PartyStatusContainer.prototype._updateSpritesetBattleActorSprites =
            function () {
              var parent = this.parent;
      ...
      (function (BattleObjects) {
        var Rectangle = (function (_super) {
          ...
          Rectangle.prototype._initializeInternal = function (properties) {
            this.propertyChanged.addPropertyChanged(
              BattleObjects.defs.width.key,
              this._drawRectangle,
              this
            );
            this.propertyChanged.addPropertyChanged(
              BattleObjects.defs.height.key,
              this._drawRectangle,
              this
            );
            this.propertyChanged.addPropertyChanged(
              BattleObjects.defs.fillColor.key,
              this._drawRectangle,
              this
            );
            this.propertyChanged.addPropertyChanged(
              BattleObjects.defs.gradientColor.key,
              this._drawRectangle,
              this
            );
            this.propertyChanged.addPropertyChanged(
              BattleObjects.defs.isGradient.key,
              this._drawRectangle,
              this
            );
            this.propertyChanged.addPropertyChanged(
              BattleObjects.defs.isVertical.key,
              this._drawRectangle,
              this
            );
            this._drawRectangle();
        ...
        var StateIcon = (function (_super) {
          ...
          StateIcon.prototype.isTouched = function () {
            ...
            if (this.orientation == Core.Consts.Enums.Orientation.Horizontal) {
              return (
                x >= 0 && y >= 0 && x < scale * this.maxStates && y < scale
              );
            } else {
              return (
                x >= 0 && y >= 0 && x < scale && y < scale * this.maxStates
              );
            }
          };
          ...
          StateIcon.prototype._initializeInternal = function (properties) {
            ...
            this._page = 0;
            this.propertyChanged.addPropertyChanged(
              BattleObjects.defs.maxStates.key,
              this._createIcons,
              this
            );
            this.propertyChanged.addPropertyChanged(
              BattleObjects.defs.stateIconSize.key,
          ...
          StateIcon.prototype._updateIcons = function () {
            ...
            if (
              !battler._states.equals(this._lastStates) ||
              ...
              if (
                this._lastIcons === undefined ||
                newIcons.equals(this._lastIcons)
              ) {
                return;
              }
              if (
                newIcons.length > this.maxStates &&
                this._lastIcons.length <= this.maxStates
              ) {
                StateIcon.iconDisplayNumber++;
                if (StateIcon.iconDisplayNumber === 1) {
                  StateIcon.updateTimingOffset =
                    Graphics.frameCount % this.animationSpeed;
                }
              } else if (
                newIcons.length <= this.maxStates &&
                this._lastIcons.length > this.maxStates
          ...
          StateIcon.prototype._updateTiming = function () {
            return (
              (StateIcon.updateTimingOffset + Graphics.frameCount) %
                this.animationSpeed ===
              0
            );
          };
          ...
          StateIcon.prototype._updateAnimation = function () {
            if (this._updateTiming()) {
              this._page =
                (this._page + 1) %
                Math.ceil(this._lastIcons.length / this.maxStates);
              this._updateDisplayIcons();
            }
          };
          StateIcon.prototype._updateDisplayIcons = function () {
            ...
            this.children.forEach(function (s, i) {
              ...
              _this.orientation == Core.Consts.Enums.Orientation.Horizontal
                ? s.position.set(i * 32 + space, 0)
                : s.position.set(0, i * 32 + space);
              s.visible = icons[i] > 0;
            });
          };
          ...
          StateIcon.prototype._syncRelatedObjects = function () {
            ...
            this.relatedObjects
              ...
              .forEach(function (x) {
                var s = _this.findFamily(
                  function (y) {
                    return (
                      y instanceof BattleObjects.Base && y.getObjectName() === x
                    );
                  },
                  function (t) {
                    return (
                      t.parent instanceof BattleObjects.PartyStatusContainer
                    );
                  }
                );
                if (s) {
      ...
      (function (BattleObjects) {
        var Text = (function (_super) {
          ...
          Text.prototype._createTextBitmap = function () {
            ...
            var width = Math.min(
              Text.measureBitmap.measureTextWidth(this.text),
              this.maxWidth
            );
            this.bitmap = new Bitmap(
              width + this.outlineWidth * 2,
              this.fontSize + this.outlineWidth
            );
            ...
            switch (this.horizontalAlignment) {
              case Core.Consts.Enums.HorizontalAlignment.Left:
                ...
                break;
              case Core.Consts.Enums.HorizontalAlignment.Center:
                this.pivot.x = Math.round(
                  width / 2 - this.maxWidth / 2 + this.outlineWidth
                );
                break;
              case Core.Consts.Enums.HorizontalAlignment.Right:
                this.pivot.x = Math.round(
                  width - this.maxWidth + this.outlineWidth
                );
                break;
            }
        ...
        (function (Components) {
          var BattlerContextContainer = (function (_super) {
            ...
            Object.defineProperty(
              BattlerContextContainer.prototype,
              "container",
              {
                get: function () {
                  return this.parent;
          ...
          (Components =
            BattleObjects.Components || (BattleObjects.Components = {}))
        );
      })((BattleObjects = HUD.BattleObjects || (HUD.BattleObjects = {})));
    })((HUD = Core.HUD || (Core.HUD = {})));
  })((Core = BD.Core || (BD.Core = {})));
          ...
          var XPStyleBattler = (function (_super) {
            ...
            XPStyleBattler.prototype.updateBitmap = function () {
              ...
              if (battlerGraphic.fileName !== null) {
                this._faceName = null;
                if (
                  !battlerGraphicManager.areEqualBattlerGraphic(
                    this._battlerGraphic,
                    battlerGraphic
                  )
                ) {
                ...
                if (this._faceName !== name_1 || this._faceIndex !== index) {
                  var b = battlerGraphicManager.battlerGraphic(
                    this._actor
                  ).bitmap;
                  if (b.isReady()) {
            ...
            XPStyleBattler.prototype._setFaceFramePosition = function (
              faceIndex
            ) {
              this._faceFrameX =
                (faceIndex % 4) * 144 + XPStyleBattler.FrameOffset;
              this._faceFrameY =
                Math.floor(faceIndex / 4) * 144 + XPStyleBattler.FrameOffset;
            };
            ...
            XPStyleBattler.prototype.updateFrame = function () {
              ...
              if (
                !this._battlerGraphic ||
                (this._battlerGraphic && this._battlerGraphic.faceIndex > -1)
              ) {
            ...
            XPStyleBattler.prototype.setupAnimation = function () {
              ...
              if (
                !Settings.enableSideVidwBattler() &&
                !Settings.battlerGraphic().enableAnimation
              ) {
            ...
            XPStyleBattler.prototype.startAnimation = function (
              animation,
              mirror,
              delay
            ) {
    ...
    (function (HUD_1) {
      ...
      var HUD = (function (_super) {
        ...
        function HUD() {
          ...
          _this.addChild(
            new Core.Targeting.TargetCursorLayer(Core.Settings.targetCursor())
          );
        ...
        HUD.prototype.updateTouchBattleObjects = function () {
          ...
          _.chain(this._battleObject.children)
            .filter(function (sprite) {
              return sprite !== firstFoundObject;
            })
            .forEach(function (sprite) {
              sprite.resetPressCount();
            });
        };
        return HUD;
      })(Sprite);
...
(function () {
  ...
  Game_Actor.prototype.baseBattlerGraphics = function () {
    if (this._baseBattlerGraphic === undefined) {
      ...
      this._baseBattlerGraphic =
        BattlerGraphicManager.createBattlerGraphic(bgRaw);
    }
  ...
  Game_Actor.prototype.conditionalBattlerGraphics = function () {
    if (this._conditionalBattlerGraphics === undefined) {
      var conditions = BD.Core.RPGExtension.getConditionalBattlerGraphicsRaw(
        this.actor()
      );
      this._conditionalBattlerGraphics = conditions
        .map(function (x) {
          return BattlerGraphicManager.createConditionalBattlerGraphic(
            x.fileName,
            x.kind,
            x.idOrTag,
            x.priority
    ...
    if (this._guardBattlerGraphicDuration >= 0) {
      if (c && c.condition.kind === Kind.damage) {
        this._guardBattlerGraphicDuration =
          BattlerGraphicManager.damageDuration();
      }
      return;
    }
    if (c == null) {
  ...
  Game_Actor.prototype.existDeadBattlerGraphic = function () {
    var d = this.conditionalBattlerGraphics().find(function (x) {
      return x.condition.kind === Kind.dead;
    });
    return d !== undefined;
  };
  Game_Actor.prototype.guardBattlerGraphicDuration = function () {
    ...
    if (this._guardBattlerGraphicDuration > 1) {
      ...
      (this._motionType !== "damage" || !Settings.enableSideVidwBattler())
    ) {
      this._guardBattlerGraphicDuration = 0;
    }
    return this._guardBattlerGraphicDuration;
  };
  Game_Actor.prototype.setConditionalBattlerGraphics = function (
    fileName,
    faceIndex,
    kind,
    idOrTag,
    ...
    var f = this._conditionalBattlerGraphics.find(function (x) {
      if (
        x.condition.kind === Kind[kind.toLowerCase()] &&
        x.condition.idOrTag === idOrTag
      ) {
        return true;
      }
    });
  ...
  Game_Actor.prototype.removeConditionalBattlerGraphics = function (
    kind,
    idOrTag
  ) {
    this.conditionalBattlerGraphics();
    ...
    if (f) {
      this._conditionalBattlerGraphics =
        this._conditionalBattlerGraphics.filter(function (x) {
          return x !== f;
        });
      this.refreshBattlerGraphic();
      return;
  ...
  var _bdc_Game_Actor_requestMotionRefresh =
  ...
  var _bdc_Game_Actor_performActionStart =
  ...
  Game_Actor.prototype._hudParam = function (paramId) {
    ...
    if (cache === undefined) {
      this._paramCache[paramId] = Game_Actor.prototype.param.apply(
        this,
        arguments
      );
...
(function () {
  var _bdc_Spriteset_Battle_createUpperLayer =
  ...
  Spriteset_Battle.prototype.createHUDSprite = function () {
    if (
      Scene_Battle.prototype.createHudField !== undefined &&
  ...
  Spriteset_Battle.prototype.updateActorSprites = function () {
    ...
    var s = this._hudSprite.flatten().filter(function (x) {
      return x instanceof BD.Core.HUD.BattleObjects.Components.XPStyleBattler;
    });
    this._actorSprites = s;
  };
  Spriteset_Battle.prototype.updateHUDSprite = function () {
    if (
      BD.Core.Manager.isStudioMode() &&
      BD.Studio.Utilities.RmvUtility.onrender
    ) {
      BD.Studio.Utilities.RmvUtility.onrender = false;
      this.createHUDSprite();
    }
  };
  var _bdc_Spriteset_Battle_createActors =
      ...
      (function (SimpleBattleLog) {
        ...
        var ActionInformationWindow = (function (_super) {
          ...
          ActionInformationWindow.prototype.refresh = function () {
            ...
            var drawIcon =
              Core.Settings.battleMessage().simpleBattleLog.drawIcon;
          ...
          ActionInformationWindow.prototype._setDescriptionFont = function () {
            var fontSize =
              Core.Settings.battleMessage().simpleBattleLog.descriptionFontSize;
            if (fontSize > 0) {
          ...
          ActionInformationWindow.prototype._getDescription = function () {
            ...
            if (desc.length > 0) {
              var delimiter =
                Core.Settings.battleMessage().simpleBattleLog
                  .descriptionDelimiter;
              return delimiter + desc;
            }
            return "";
          };
          ActionInformationWindow.prototype._measureItemWidth = function (
            needIcon
          ) {
            this.resetFontSettings();
          ...
          ActionInformationWindow.prototype._measureDescriptionWidth =
          ...
          ActionInformationWindow.prototype._drawActionInformation = function (
            itemWidth,
            descWidth,
            needIcon,
            description,
          ...
          ActionInformationWindow.prototype._calcDrawX = function (
            totalWidth,
            align
          ) {
            switch (align) {
        ...
        (SimpleBattleLog =
          Message.SimpleBattleLog || (Message.SimpleBattleLog = {}))
      );
...
(function () {
  var _bdc_Scene_Battle_createAllWindows =
  ...
  Scene_Battle.prototype.createActionInformationWindow = function () {
    this._actionInformationWindow =
      new BD.Core.Message.SimpleBattleLog.ActionInformationWindow();
...
(function () {
  var Settings = BD.Core.Settings;
  var _bdc_Window_BattleLog_startAction =
  ...
  Window_BattleLog.prototype._showActionInformation = function (
    subject,
    action
  ) {
    ...
    if (action.isSkill()) {
      ...
      var displayAttack =
        Settings.battleMessage().simpleBattleLog.displayAttack;
  ...
  Window_BattleLog.prototype._isSimpleBattleLog = function () {
    var useSimpleBattleLog =
      Settings.battleMessage().simpleBattleLog.useSimpleBattleLog;
    return useSimpleBattleLog && this.actionInformationWindow !== undefined;
  };
  ...
  var _bdc_Window_BattleLog_drawLineText =
  ...
  var _bdc_Window_BattleLog_messageSpeed =
  ...
  var _bdc_Window_BattleLog_displayActionResults =
...
(function () {
  ...
  var _bdc_Sprite_Battler_updateSelectionEffect =
...
(function () {
  ...
  BattleManager.doStartInputCallback = function () {
    this._startInputCallback.forEach(function (x) {
      return x[0].call(x[1]);
    });
  };
...
(function () {
  ...
  Game_Action.prototype.makeTargets = function () {
    ...
    if (this.subject().isActor() && this.isForOpponent() && this.isForAll()) {
...
(function () {
  ...
  Scene_Battle.prototype.createTargetInformationWindow = function () {
    this._targetInformationWindow =
      new BD.Core.Targeting.TargetInformationWindow();
...
(function () {
  ...
  Sprite_Actor.prototype._targetingHitTest = function () {
    ...
    var rect = new Rectangle(
      s.x - s._mainSprite.width / 2,
      s.y - s._mainSprite.height,
      s._mainSprite.width,
      s._mainSprite.height
    );
...
(function () {
  var _bdc_Window_BattleEnemy_initialize =
...
(function () {
  var _bdc_Window_BattleStatus_initialize =
    ...
    (function (Targeting) {
      var TargetCursor = (function (_super) {
        ...
        TargetCursor.prototype._updateAnimation = function () {
          ...
          if (
            this._blink &&
            Math.floor(Math.ceil(Graphics.frameCount / 2)) % 2 === 0
          ) {
        ...
        TargetCursor.prototype._updatePosition = function () {
          if (this._progressRate === null) {
            ...
            this._progressRate = Core.Utils.Interpolator.smooth(
              1,
              this._progressRate,
              this._moveSpeed,
              0.005
          ...
          if (this._target instanceof Game_Actor && !this._target.hasXpb()) {
            this._setTargetPosition(
              this._target.cursorX(),
              this._target.cursorY()
            );
          }
          this.x = Math.round(
            this._rx - (this._rx - this._tx) * this._progressRate
          );
          this.y = Math.round(
            this._ry - (this._ry - this._ty) * this._progressRate
          );
        };
        ...
        TargetCursor.prototype.setTarget = function (target, startX, startY) {
          var aPos = target.isActor()
            ? this._adjustPositionOnActor
            : this._adjustPositionOnEnemy;
          this._setPosition(
            target.cursorX() + aPos.x,
            target.cursorY() + aPos.y
          );
    ...
    (function (Targeting) {
      var TargetCursorLayer = (function (_super) {
        ...
        TargetCursorLayer.prototype._updateTarget = function () {
          ...
          var battlers = this._allBattlers.filter(function (x) {
            return x.isSelected() && (x.isActor() || x.isAlive());
          });
        ...
        TargetCursorLayer.prototype._updateSingleTarget = function (
          selectedBattler,
          command
        ) {
          var s = [selectedBattler];
          if (
            this._lastSelectedBattlers.equals(s) &&
        ...
        TargetCursorLayer.prototype._updateMultipleTarget = function (
          selectedBattlers
        ) {
          var _this = this;
        ...
        TargetCursorLayer.prototype._hideSubCursors = function () {
          ...
          this._subCursors.forEach(function (x) {
            return _this.removeChild(x);
          });
        ...
        TargetCursorLayer.prototype._updateMembers = function () {
          ...
          this._allBattlers = this._partyBattleMembers.concat(
            this._troopMembers
          );
        };
    ...
    (function (Targeting) {
      ...
      var TargetInformationWindow = (function (_super) {
        ...
        TargetInformationWindow.prototype._drawForParty = function () {
          this.drawText(
            InfoSettings().scopeNotation.forParty,
            0,
            0,
            this.contentsWidth(),
            "center"
        ...
        TargetInformationWindow.prototype._drawForTroop = function () {
          this.drawText(
            InfoSettings().scopeNotation.forTroop,
            0,
            0,
            this.contentsWidth(),
            "center"
        ...
        TargetInformationWindow.prototype._drawForTroopRandom = function (
          randomNumber
        ) {
          var text =
            InfoSettings().scopeNotation.forTroopRandom.format(randomNumber);
          this.drawText(text, 0, 0, this.contentsWidth(), "center");
        };
        TargetInformationWindow.prototype._drawTargetInformation = function (
          battler
        ) {
          var settings = battler.isActor()
            ? InfoSettings().actor
            : InfoSettings().enemy;
          ...
          var gaugesBaseX =
            this.contentsWidth() -
            gaugeWidth * gauges -
            gaugeMargin * Math.max(0, gauges - 1);
          ...
          var nameWidth = Math.min(
            this.contents.measureTextWidth(battler.name()),
            nameAndStateWidth
          );
          var minNameWidth = Math.round(
            nameWidth * TargetInformationWindow.MIN_NAME_RATIO
          );
          ...
          if (settings.states) {
            stateWidth = Math.min(
              maxStateWidth,
              battler.allIcons().length * Window_Base._iconWidth
            );
          }
          var realStateWidth = Math.min(stateWidth, maxStateWidth);
          var realNameWidth = Math.min(
            nameWidth,
            nameAndStateWidth - realStateWidth
          );
          var realNameAndStateWidth = realNameWidth + realStateWidth;
          var nameX = Math.round(
            (nameAndStateWidth - realNameAndStateWidth) / 2
          );
        ...
        TargetInformationWindow.prototype.drawGauges = function (
          settings,
          battler,
          baseX
        ) {
        ...
        TargetInformationWindow.prototype.gaugeX = function (baseX, column) {
          return (
            baseX +
            InfoSettings().gaugeWidth * column +
            TargetInformationWindow.GAUGE_MARGIN * column
          );
        };
        TargetInformationWindow.prototype.setText = function (text) {};
        TargetInformationWindow.prototype.setItem = function (item) {};
        TargetInformationWindow.prototype.drawActorIcons = function (
          actor,
          x,
          y,
          width
          ...
          var displayIcons = icons.slice(
            0,
            Math.floor(w / Window_Base._iconWidth)
          );
    ...
    (function (Targeting) {
      var TargetTouchSelector = (function () {
        ...
        TargetTouchSelector.prototype.update = function () {
          this._stayCount++;
          if (
            !this._selector.active ||
            this._stayCount < TargetTouchSelector.Stay
          ) {
            return;
          }
          if (this._decision()) {
        ...
        TargetTouchSelector.prototype._select = function () {
          ...
          if (!this._selector.cursorFixed() && TouchInput.isPressed()) {
            var target = this._sortedMember.find(function (x) {
              return _this._hitTest(x);
            });
            if (target === undefined) {
              return false;
            }
        ...
        TargetTouchSelector.prototype._hitTest = function (battler) {
          if (
            battler.touchInputStatus() !==
            Core.Consts.Enums.TouchInputStatus.NoInput
          ) {
            return true;
          }
...
(function () {
  ...
  Window_ActorCommand.prototype._updatePosition = function () {
    ...
    if (absolutePos.x !== undefined) {
      ...
      var x = (this._actor.cursorX() - this.width / 2 + adjustPos.x).clamp(
        8,
        Graphics.boxWidth - this.width - 8
      );
      this.x = x;
    }
...
(function () {
  var _bdc_Scene_Battle_createMessageWindow =
