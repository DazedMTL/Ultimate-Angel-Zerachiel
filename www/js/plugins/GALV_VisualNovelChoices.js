...
(function () {
  Galv.VNC.width = Number(
    PluginManager.parameters("Galv_VisualNovelChoices")["Command Width"]
  );
  Galv.VNC.height = Number(
    PluginManager.parameters("Galv_VisualNovelChoices")["Command Height"]
  );
  Galv.VNC.alwaysMid =
    PluginManager.parameters("Galv_VisualNovelChoices")[
      "Always Middle"
    ].toLowerCase() == "true"
      ? true
      : false;
  Galv.VNC.msgGap = Number(
    PluginManager.parameters("Galv_VisualNovelChoices")["Message Gap"]
  );
  Galv.VNC.disableBtn = Number(
    PluginManager.parameters("Galv_VisualNovelChoices")["Disabled Button"]
  );
  ...
  // Overwrite
  Window_ChoiceList.prototype.textHeight =
    Window_ChoiceList.prototype.lineHeight;
  Galv.VNC.Window_ChoiceList_lineHeight =
    Window_ChoiceList.prototype.lineHeight;
  Window_ChoiceList.prototype.lineHeight = function () {
    return $gameSystem.vnChoices
      ? Galv.VNC.height
      : Galv.VNC.Window_ChoiceList_lineHeight.call(this);
  };
  Galv.VNC.Window_ChoiceList_itemHeight =
    Window_ChoiceList.prototype.itemHeight;
  Window_ChoiceList.prototype.itemHeight = function () {
    return $gameSystem.vnChoices
      ? Galv.VNC.height
      : Galv.VNC.Window_ChoiceList_itemHeight.call(this);
  };
  ...
  Galv.VNC.Window_ChoiceList_updatePlacement =
  ...
  Galv.VNC.Window_ChoiceList__refreshCursor =
    Window_ChoiceList.prototype._refreshCursor;
  ...
  Window_ChoiceList.prototype.drawButton = function (index, y, cursor) {
    ...
    if (cursor) {
      ...
      if (this._list[index].enabled === false) {
        ...
        var bgId = this.choice_background[index]
          ? this.choice_background[index]
          : 1;
      }
    }
    var sy = bgId * ph;
  ...
  Galv.VNC.Window_ChoiceList_updateBackground =
  ...
  Galv.VNC.Window_ChoiceList_convertEscapeCharacters =
    Window_ChoiceList.prototype.convertEscapeCharacters;
  ...
  Galv.VNC.Window_ChoiceList_maxChoiceWidth =
