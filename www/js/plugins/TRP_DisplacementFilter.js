...
(function () {
  ...
  Game_Screen.prototype.startDisplacementFilter = function (
    sx,
    sy,
    scale,
    image,
  ...
  Game_Screen.prototype.clearDisplacementFilter = function (
    sx,
    sy,
    scale,
    image
  ...
  Game_Map.prototype.setup = function (mapId) {
    ...
    var parallax_displacement = $dataMap.meta
      ? $dataMap.meta.parallax_displacement
      : null; // added by nekoma
    if (displacement) {
      this.setupDisplacement(displacement);
    } else if (parallax_displacement) {
      // added by nekoma from
  ...
  Game_Map.prototype.setupDisplacement = function (displacement, parallax) {
    // modified by nekoma to
  ...
  Scene_Map.prototype.setupDisplacementFilters = function (setting) {
    ...
    this._displacement.scale = setting.scale;
    this._displacement.filter.scale = new PIXI.Point(
      setting.scale,
      setting.scale
    );
  };
  ...
  Scene_Map.prototype.removeDisplacementFilter = function () {
    ...
    var allFilters = setting.parallax
      ? this._spriteset._parallax.filters
      : this.filters; // modified by nekoma to
