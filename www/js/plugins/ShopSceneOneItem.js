...
(function () {
  ...
  Window_ShopNumber.prototype.activate = function () {
    if ($gameTemp.isShopNumber())
      _Window_ShopNumber_activate.apply(this, arguments);
  };

  var _Window_ShopNumber_show = Window_ShopNumber.prototype.show;
  Window_ShopNumber.prototype.show = function () {
    if ($gameTemp.isShopNumber())
      _Window_ShopNumber_show.apply(this, arguments);
  };
  ...
  Game_Interpreter.prototype.pluginCommand = function (command, args) {
    ...
    if (
      commandName === "shopitemnumber" ||
      commandName === "ショップ個数選択"
    ) {
