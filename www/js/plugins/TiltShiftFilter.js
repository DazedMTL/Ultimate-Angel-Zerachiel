  ...
  })(
    {
      ...
      2: [
        function (require, module, exports) {
          ...
          function TiltShiftAxisFilter() {
            ...
            this.uniforms.end = new PIXI.Point(
              Graphics.width,
              Graphics.height / 2
            );
      ...
      3: [
        function (require, module, exports) {
          ...
          TiltShiftFilter.prototype.apply = function (
            filterManager,
            input,
            output
          ) {
            var renderTarget = filterManager.getRenderTarget(true);
            this.tiltShiftXFilter.texSize = new PIXI.Point(
              renderTarget.size.width,
              renderTarget.size.height
            );
            this.tiltShiftYFilter.texSize = new PIXI.Point(
              renderTarget.size.width,
              renderTarget.size.height
            );

            this.tiltShiftXFilter.apply(
              filterManager,
              input,
              renderTarget,
              true
        ...
        { "./TiltShiftXFilter": 4, "./TiltShiftYFilter": 5 },
      ],
      4: [
        function (require, module, exports) {
