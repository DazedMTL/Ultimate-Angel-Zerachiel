...
(function () {
	...
	*---------------------------------------------*/
	...
	Scene_CraftingMenu.prototype.create = function () {
		...
		this._ingredientsWindow = new Window_CraftingIngredients(this._indexWindow.width, this._statusWindow.y + this._statusWindow.height, 500, Graphics.height - this._statusWindow.y - this._statusWindow.height);
