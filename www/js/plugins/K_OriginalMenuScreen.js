...
(function () {
  ...
  var Information_Msg = {
    item: String(
      parameters["Information_item"] || "入手したアイテムを使用します。"
    ),
    skill: String(
      parameters["Information_skill"] || "習得したスキルを確認します。"
    ),
    equip: String(
      parameters["Information_equip"] || "武器や防具などを装着します。"
    ),
    class: String(
      parameters["Information_class"] ||
        "職業を変更します。戦闘を重ねることで職業が成長します。"
    ),
    status: String(
      parameters["Information_status"] || "ステータスを確認します。"
    ),
    EQS: String(
      parameters["Information_EQS"] ||
        "職業の変更やアビリティの装着を行います。"
    ),
    materia: String(
      parameters["Information_materia"] ||
        "メモリアを装着し、武器を強化します。"
    ),
    skilltree: String(
      parameters["Information_skilltree"] || "アビリティを習得し、強化します。"
    ),
    statAllocate: String(
      parameters["Information_statAllocate"] || "ステータスを強化します。"
    ),
    glossary1: String(
      parameters["Information_glossary1"] ||
        "冒険に役立つ情報や回想、性経験を確認します。"
    ),
    formation: String(
      parameters["Information_formation"] || "キャラクターの隊列を変更します。"
    ),
    options: String(
      parameters["Information_options"] || "オプション画面を開きます。"
    ),
    battleFormation: String(
      parameters["Information_battleFormation"] ||
        "陣形を選択することで、特殊な効果が得られます。"
    ),
    save: String(
      parameters["Information_save"] || "これまでのデータを保存します。"
    ),
    load: String(
      parameters["Information_load"] || "保存したデータを読み込みます。"
    ),
    "parent\\I[850] システム0": String(
      parameters["Information_parent\\I[850] システム0"] ||
        "データの保存、読み込み、オプションの変更などを行います。"
    ),
    "parent\\I[893] 育成0": String(
      parameters["Information_parent\\I[893] 育成0"] ||
        "職業の変更や能力の強化、アビリティの装着を行います。"
    ),
    "parent\\I[883] 編成0": String(
      parameters["Information_parent\\I[883] 編成0"] ||
        "並び替えや陣形の変更をします。"
    ),
  };
  ...
  Scene_Menu.prototype.update = function () {
    ...
    this._informationWindow.setText(
      Information_Msg[this._commandWindow.currentSymbol()]
    );
  };
  ...
  Window_Information.prototype.initialize = function () {
    ...
    var height =
      Add_LocationInfo == 1 ? this.fittingHeight(2) : this.fittingHeight(1);
