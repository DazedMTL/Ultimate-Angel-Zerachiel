...
Moghunter.battleStartMessage = String(
  Moghunter.parameters["Display Start Message"] || "false"
);
Moghunter.battlePreemptiveMessage = String(
  Moghunter.parameters["Display Preemptive Message"] || "true"
);
//=============================================================================
// ** Window BattleLog
//=============================================================================
