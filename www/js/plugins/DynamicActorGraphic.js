...
(function () {
  ...
  Game_Actor.prototype.refreshCustomGraphicForState = function () {
    ...
    this.getSortedStates().forEach(function (stateId) {
      this.setCharacterCustom(
        getMetaValue(actor, "CHARACTER_ST" + String(stateId))
      );
      this.setFaceCustom(getMetaValue(actor, "FACE_ST" + String(stateId)));
      this.setBattlerCustom(
        getMetaValue(actor, "BATTLER_ST" + String(stateId))
      );
    }, this);
  };
  ...
  Game_Actor.prototype.refreshCustomGraphicForHpRate = function () {
    ...
    for (var hpRate = 10; hpRate <= 100; hpRate += 10) {
      ...
      this.setCharacterCustom(
        getMetaValue(actor, "CHARACTER_HP" + String(hpRate))
      );
  ...
  Game_Actor.prototype.refreshCustomGraphicForMpRate = function () {
    ...
    for (var mpRate = 10; mpRate <= 100; mpRate += 10) {
      ...
      this.setCharacterCustom(
        getMetaValue(actor, "CHARACTER_MP" + String(mpRate))
      );
  ...
  Game_Actor.prototype.refreshCustomGraphicForSwitch = function () {
    var actor = this.actor();
    Object.keys(actor.meta).forEach(
      function (metaName) {
        metaName.replace(
          /CHARACTER_SWITCH(\d+)/i,
          function () {
  ...
  Game_Actor.prototype.getSortedStates = function () {
    return this._states
      .clone()
      .sort(this.compareOrderStateIdPriority.bind(this));
  };

  Game_Actor.prototype.compareOrderStateIdPriority = function (
    stateIdA,
    stateIdB
  ) {
