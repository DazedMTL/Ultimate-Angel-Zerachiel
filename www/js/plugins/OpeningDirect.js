...
Liquidize.OpeningDirect.FileNames = String(
  Liquidize.OpeningDirect.Parameters["File Names"]
);
Liquidize.OpeningDirect.FadeTime =
  Number(Liquidize.OpeningDirect.Parameters["Fade Time"]) || 120;
Liquidize.OpeningDirect.WaitTime =
  Number(Liquidize.OpeningDirect.Parameters["Wait Time"]) || 160;
...
(function () {
  ...
  Scene_Opening.prototype.initialize = function () {
    ...
    this._TotalTime =
      this._FadeTime * this._Sheets + this._WaitTime * this._Sheets;
  ...
  Scene_Opening.prototype.update = function () {
    if (!this._LastWaiteMode) {
      ...
      if (this._RemaininglTime-- == 0) {
        ...
        var alpha_rate =
          (this._RemaininglTime - this._WaitTime) / this._FadeTime;
        if (alpha_rate > 1.0) {
          alpha_rate = 1.0;
        }
