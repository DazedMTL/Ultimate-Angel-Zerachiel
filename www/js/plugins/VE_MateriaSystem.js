...
(function () {
  ...
  PluginManager.requiredPlugin = function (name, required, version) {
    if (!VictorEngine.BasicModule) {
      ...
      VictorEngine.MateriaSystem.requiredPlugin.call(
        this,
        name,
        required,
        version
...
(function () {
  ...
  if (Imported["VE - Basic Module"]) {
    ...
    VictorEngine.Parameters.MateriaSystem.MateriaNumber =
      Number(parameters["Max Materia Number"]) || 0;
    VictorEngine.Parameters.MateriaSystem.MaxSlotNumber = Number(
      parameters["Max Slot Number"]
    );
    VictorEngine.Parameters.MateriaSystem.SingleSlotIcon =
      Number(parameters["Single Slot Icon"]) || 0;
    VictorEngine.Parameters.MateriaSystem.LinkSlotLeft =
      Number(parameters["Link Slot Left"]) || 0;
    VictorEngine.Parameters.MateriaSystem.LinkSlotCenter =
      Number(parameters["Link Slot Center"]) || 0;
    VictorEngine.Parameters.MateriaSystem.LinkSlotRight =
      Number(parameters["Link Slot Right"]) || 0;
    VictorEngine.Parameters.MateriaSystem.MateriaLevel =
      Number(parameters["Materia Level Icon"]) || 0;
    VictorEngine.Parameters.MateriaSystem.MateriaDisplay =
      Number(parameters["Materia Display Type"]) || 1;
    VictorEngine.Parameters.MateriaSystem.MateriaMenu = String(
      parameters["Materia Menu Name"]
    ).trim();
    VictorEngine.Parameters.MateriaSystem.MateriaApName = String(
      parameters["Materia Ap Name"]
    ).trim();
    VictorEngine.Parameters.MateriaSystem.ApReceived = String(
      parameters["Ap Received Text"]
    ).trim();
    VictorEngine.Parameters.MateriaSystem.MasterText = String(
      parameters["Materia Master Text"]
    ).trim();
    VictorEngine.Parameters.MateriaSystem.NextLevelText = String(
      parameters["Next Level Text"]
    ).trim();
    VictorEngine.Parameters.MateriaSystem.AbilityListText = String(
      parameters["Ability List Text"]
    ).trim();
    VictorEngine.Parameters.MateriaSystem.ParamListText = String(
      parameters["Param List Text"]
    ).trim();
    VictorEngine.Parameters.MateriaSystem.EquipedText = String(
      parameters["Equiped Materia Text"]
    ).trim();
    VictorEngine.Parameters.MateriaSystem.AftermathText = String(
      parameters["Aftermath Text"]
    ).trim();
    VictorEngine.Parameters.MateriaSystem.AftermathFormat = String(
      parameters["Aftermath Format"]
    ).trim();
    VictorEngine.Parameters.MateriaSystem.AftermathAP = String(
      parameters["Aftermath AP Earned"]
    ).trim();
    VictorEngine.Parameters.MateriaSystem.MateriaBreeding = eval(
      parameters["Materia Breeding"]
    );
    VictorEngine.Parameters.MateriaSystem.CursorPriority = eval(
      parameters["Cursor High Priority"]
    );
  }
  ...
  VictorEngine.MateriaSystem.loadNotetagsValues =
  ...
  VictorEngine.MateriaSystem.initializeGameSystem =
  ...
  VictorEngine.MateriaSystem.makeDamageValue =
    Game_Action.prototype.makeDamageValue;
  Game_Action.prototype.makeDamageValue = function (target, critical) {
    var value = VictorEngine.MateriaSystem.makeDamageValue.call(
      this,
      target,
      critical
    );
  ...
  VictorEngine.MateriaSystem.executeDamage =
  ...
  VictorEngine.MateriaSystem.makeAllDamageValue =
    Game_Action.prototype.makeAllDamageValue;
  ...
  VictorEngine.MateriaSystem.toggleableScope =
    Game_Action.prototype.toggleableScope;
  Game_Action.prototype.toggleableScope = function () {
    return (
      VictorEngine.MateriaSystem.toggleableScope.call(this) ||
      this.isForAllMateria()
    );
  };

  Game_Action.prototype.isLimitedUse = function () {
    return (
      !this.subject().isEnemy() && this.subject().limitedUseMateria(this.item())
    );
  };
  ...
  Game_Action.prototype.materiaDamagePlus = function (skillId) {
    return this.subject()
      .allMaterias()
      .reduce(function (r, materia) {
        return (
          r + (materia.isDamage(skillId) ? materia.effectRate("damage") : 0)
        );
      }, 0);
  };
  ...
  Game_Action.prototype.pairAbsorb = function (target, value, skillId, type) {
    ...
    var result = Math.floor(
      value * this.pairAbsorbValue(skillId, effect, "hasSkill")
    );
    if (result > 0) {
      if (type === "hp") {
  ...
  Game_Action.prototype.isMateriaDamage = function (
    pair,
    skillId,
    effect,
    check
    ...
    return (
      this.subject().pairHasEffect(pair, skillId, effect, null, check) &&
      !$dataSkills[skillId].materiaNegate.damage
    );
  };

  Game_Action.prototype.isMateriaAbsorb = function (
    pair,
    skillId,
    effect,
    check
  ...
  VictorEngine.MateriaSystem.clearStates =
  ...
  Game_BattlerBase.prototype.clearStates = function () {
    ...
    materiaStates.forEach(function (state) {
  ...
  VictorEngine.MateriaSystem.meetsSkillConditions =
    Game_Actor.prototype.meetsSkillConditions;
  Game_Actor.prototype.meetsSkillConditions = function (skill) {
    return (
      VictorEngine.MateriaSystem.meetsSkillConditions.call(this, skill) &&
  ...
  VictorEngine.MateriaSystem.attackElements =
  ...
  VictorEngine.MateriaSystem.attackStatesRate =
    Game_Actor.prototype.attackStatesRate;
  Game_Actor.prototype.attackStatesRate = function (stateId) {
    var result = VictorEngine.MateriaSystem.attackStatesRate.call(
      this,
      stateId
    );
  ...
  VictorEngine.MateriaSystem.changeEquipById =
  ...
  VictorEngine.MateriaSystem.canToggleScope =
    Game_Actor.prototype.canToggleScope;
  ...
  VictorEngine.MateriaSystem.forceChangeEquip =
  ...
  Game_Actor.prototype.allMaterias = function () {
    ...
    return list.filter(function (materia) {
      return !!materia;
    });
  };
  ...
  Game_Actor.prototype.setupCurrentSlots = function () {
    this._currentSlots = this._materiaSlots.map(function (slot) {
      return slot;
    });
  ...
  Game_Actor.prototype.refreshMateriaSlots = function (slot, i) {
    ...
    if (slots) {
      materias = slots.materias.map(function (materia) {
        return materia;
      });
    }
  ...
  Game_Actor.prototype.materiaChangeCost = function (skillId, pair) {
    return (
      pair.main.pair("mp cost") &&
      this.pairHasSkill(pair, skillId) &&
  ...
  Game_Actor.prototype.materiaAttackElements = function (set) {
    ...
    return set.filter(function (i, n, self) {
      return self.indexOf(i) === n;
    });
  };
  ...
  Game_Actor.prototype.materiaEffectAttackElements = function (set) {
    ...
    return this._materiaSlots.reduce(function (r, slots) {
      var elements = object.getMateriasEffects(
        slots,
        "elemental",
        "weapon",
        "elements"
  ...
  Game_Actor.prototype.materiaPairedAttackElements = function (set) {
    ...
    return this.pairedMateria().reduce(function (r, pair) {
      var elements = object.getPairsEffects(
        pair,
        "elemental",
        "weapon",
        "elements"
  ...
  Game_Actor.prototype.materiaEffectElementRate = function (stateId) {
    var object = this;
    return this._materiaSlots.reduce(function (r, slots) {
      var rate = object.materiaHasEffect(
        slots,
        stateId,
        "elemental",
        "armor",
  ...
  Game_Actor.prototype.materiaPairedElementRate = function (elementId) {
    var object = this;
    return this.pairedMateria().reduce(function (r, pair) {
      var value = object.pairHasEffect(
        pair,
        elementId,
        "elemental",
        "armor",
  ...
  Game_Actor.prototype.materiaEffectAttackStates = function (set) {
    var object = this;
    return this._materiaSlots.reduce(function (r, slots) {
      var states = object.getMateriasEffects(
        slots,
        "added effect",
        "weapon",
        "states"
  ...
  Game_Actor.prototype.materiaPairedAttackStates = function (set) {
    var object = this;
    return this.pairedMateria().reduce(function (r, pair) {
      var states = object.getPairsEffects(
        pair,
        "added effect",
        "weapon",
        "states"
  ...
  Game_Actor.prototype.getMateriasEffects = function (
    slots,
    effect,
    type,
    object
  ...
  Game_Actor.prototype.materiaHasEffect = function (
    slots,
    itemId,
    effect,
    type,
  ...
  Game_Actor.prototype.pairHasEffect = function (
    pair,
    itemId,
    effect,
    type,
  ...
  Game_Actor.prototype.isAllMateriaSkill = function (pair, skillId) {
    return (
      this.pairHasSkill(pair, skillId) &&
      !$dataSkills[skillId].materiaNegate.all
    );
  };
  ...
  Game_Actor.prototype.pairHasSkill = function (pair, skillId) {
    return (
      (pair.left && pair.left.hasSkill(skillId)) ||
      (pair.right && pair.right.hasSkill(skillId))
    );
  };

  VictorEngine.MateriaSystem.checkLearnEnemySkill =
    Game_Actor.prototype.checkLearnEnemySkill;
  Game_Actor.prototype.checkLearnEnemySkill = function (skillId, type) {
    ...
    this.allMaterias().forEach(function (materia) {
      if (
        materia.learnType() === type &&
        Math.random() < materia.enemySkillRate(skillId) &&
        materia.canLearnEnemySkill(skillId)
      ) {
        this._learnEnemySkill = {
          id: skillId,
          anim: materia.learnAnim(),
          materia: materia,
        };
      }
    }, this);
  ...
  VictorEngine.MateriaSystem.processLearnEnemySkill =
    Game_Actor.prototype.processLearnEnemySkill;
  Game_Actor.prototype.processLearnEnemySkill = function (skillId) {
    if (this.learnEnemySkill().materia) {
      this.processLearnMateiraEnemySkill(
        this.learnEnemySkill().materia,
        skillId
      );
    } else {
  ...
  Game_Actor.prototype.processLearnMateiraEnemySkill = function (
    materia,
    skillId
  ) {
  ...
  Game_Party.prototype.gainItem = function (item, amount, includeEquip) {
    if (item && item.isMateria) {
      ...
      VictorEngine.MateriaSystem.gainItem.call(
        this,
        item,
        amount,
        includeEquip
  ...
  VictorEngine.MateriaSystem.isAnyMemberEquipped =
  ...
  VictorEngine.MateriaSystem.discardMembersEquip =
    Game_Party.prototype.discardMembersEquip;
  ...
  VictorEngine.MateriaSystem.pluginCommand =
  ...
  VictorEngine.MateriaSystem.addOriginalCommands =
  ...
  VictorEngine.MateriaSystem.isEquipItem =
    Window_ShopStatus.prototype.isEquipItem;
  Window_ShopStatus.prototype.isEquipItem = function () {
    return (
      VictorEngine.MateriaSystem.isEquipItem.call(this) && !this._item.isMateria
    );
  };

  VictorEngine.MateriaSystem.drawPossession =
  ...
  Window_ShopStatus.prototype.drawPossession = function (x, y) {
    ...
    if (this._item.isMateria) {
      ...
      this.drawText(
        VictorEngine.Parameters.MateriaSystem.EquipedText,
        x,
        y + height,
      ...
      this.resetTextColor();
      this.drawText(
        $gameParty.equipedMateria(this._item),
        x,
        y + height,
        width,
        "right"
  ...
  VictorEngine.MateriaSystem.drawSkillCost =
  ...
  VictorEngine.MateriaSystem.createCommandWindow =
  ...
  VictorEngine.MateriaSystem.activateSellWindow =
  ...
  VictorEngine.MateriaSystem.onCategoryCancel =
  ...
  Scene_Shop.prototype.createMateriaSellWindow = function () {
    ...
    this._materiaSellWindow.setHandler(
      "cancel",
      this.onSellMateriaCancel.bind(this)
    );
...
(function () {
  ...
  Window_MateriaStatus.prototype.drawMateriaAp = function () {
    if (!this.materia().noLevel()) {
      ...
      this.changeTextColor(this.systemColor());
      this.drawText(
        VictorEngine.Parameters.MateriaSystem.MateriaApName,
        0,
        lh,
        w2,
        "right"
      ...
      this.drawText(
        VictorEngine.Parameters.MateriaSystem.NextLevelText,
        0,
        lh + fs,
        w2,
        "right"
  ...
  Window_MateriaStatus.prototype.linesNumber = function (y) {
    return (
      Math.floor((this.contents.height - y) / (this.contents.fontSize + 2)) - 1
    );
  };
  ...
  Window_MateriaStatus.prototype.drawMateriaSkills = function () {
    ...
    this.materia()
      ...
      .forEach(function (skill, i) {
        ...
        //↓Mod koke 20221002
        // this.drawIcon($dataSkills[skill.id].iconIndex, x1 - (this.standardPadding() + 4), y1);
        this.drawIcon(
          $dataSkills[skill.id].iconIndex,
          x1 - this.contents.fontSize,
          y1 + 2
        );

        // this.drawText($dataSkills[skill.id].name, x1, y1)
        this.drawText($dataSkills[skill.id].name, x1 + 12, y1);
        //↑Mod koke 20221002
      }, this);
    this.changePaintOpacity(true);
  };
  ...
  Window_MateriaStatus.prototype.drawMateriaEffects = function (
    h,
    y,
    ln,
    wd,
  ...
  Window_MateriaStatus.prototype.drawMateriaPaireds = function (
    h,
    y,
    ln,
    wd,
  ...
  Window_MateriaStatus.prototype.drawEffectText = function (
    effect,
    x1,
    y1,
    y2,
  ...
  Window_MateriaStatus.prototype.drawEffectValue = function (
    effect,
    x,
    y,
    level,
    ...
    var value = String(
      Math.abs(parseFloat(value.toPrecision(2)) * level)
    ).padZero(pad);
    this.drawEffectInfo(name, value, x, y, sign, rate, pad, color);
  };

  Window_MateriaStatus.prototype.drawEffectInfo = function (
    name,
    value,
    x,
    y,
    ...
    this.changeTextColor(
      sign === (color ? "+" : "-") ? this.deathColor() : this.crisisColor()
    );
...
(function () {
  ...
  Window_MateriaEquip.prototype.materia = function () {
    var slots = this.actor()
      ? this.actor().materiaSlots()[this.slotIndex()] || {}
      : {};
  ...
  Window_MateriaEquip.prototype.drawMateriaSlots = function (slot, x, y) {
    ...
    if (item.slots) {
      var slots = item.slots.filter(function (i) {
        return i !== "=" && i !== ":";
      });
  ...
  Window_MateriaEquip.prototype.drawMateriaIcons = function (
    slot,
    x,
    y,
    index
  ...
  Window_MateriaEquip.prototype.itemRect = function (index) {
    ...
    rect.x =
      this.materiaX() + (index % maxCols) * this.itemWidth() - this._scrollX;
    rect.y =
      Math.floor(index / maxCols) * this.itemHeight() - this._scrollY + adj;
    return rect;
  };
  ...
  Window_MateriaEquip.prototype.isCurrentItemEnabled = function () {
    ...
    return slots && slots.materias
      ? this.materiaIndex() < slots.materias.length
      : false;
  };
  ...
  Window_MateriaEquip.prototype.cursorRight = function () {
    ...
    var maxCols = this.maxCols();
    this.select(
      (Math.floor(index / maxCols) * maxCols + ((index + 1) % maxCols)) %
        maxItems
    );
    this.refresh();
  };
  ...
  Window_MateriaEquip.prototype.cursorLeft = function () {
    ...
    var maxCols = this.maxCols();
    this.select(
      (Math.floor(index / maxCols) * maxCols +
        ((index - 1 + maxCols) % maxCols)) %
        maxItems
    );
    this.refresh();
  };
...
(function () {
  ...
  Window_MateriaItem.prototype.slots = function (index) {
    var value = this.actor()
      ? this.actor().materiaSlots()[this.slotIndex()]
      : null;
    var slots = value && value.data ? value.data.slots : [];
    return slots.filter(function (i) {
      return i !== "=" && i !== ":";
    })[index];
  };
  ...
  Window_MateriaItem.prototype.canEquipMateria = function (materia) {
    ...
    return (
      (item.atypeId === 0 || this.actor().canEquip(item)) &&
...
(function () {
  ...
  Game_Materia.prototype.isAll = function (skillId) {
    this.times(skillId);
    return (
      Imported["VE - Toggle Targets"] &&
      !!this.pair("all") &&
      this._times[skillId] > 0
    );
  };
  ...
  Game_Materia.prototype.maxAp = function () {
    return (
      this.values().ap.reduce(function (r, value) {
        return r + value;
      }, 0) || 0
    );
  };
  ...
  Game_Materia.prototype.levelUp = function () {
    this._level++;
    if (
      VictorEngine.Parameters.MateriaSystem.MateriaBreeding &&
      this.level() === this.max()
    ) {
  ...
  Game_Materia.prototype.traitSkills = function () {
    ...
    return this.item()
      .traits.reduce(function (r, trait) {
...
if (Imported.YEP_VictoryAftermath) {
  ...
  Window_VictoryAp.prototype.drawApGained = function (actor, rect) {
    ...
    this.changeTextColor(this.systemColor());
    this.drawText(
      VictorEngine.Parameters.MateriaSystem.AftermathAP,
      rect.x + 2,
      wy,
      rect.width - 4,
      "left"
    ...
    var bonusAp =
      (1.0 * BattleManager._rewards.materiaAp * this._tick) /
  ...
  VictorEngine.MateriaSystem.addCustomVictorySteps =
  ...
  VictorEngine.MateriaSystem.updateVictorySteps =
  ...
  Scene_Battle.prototype.createVictoryAp = function () {
    this._victoryTitleWindow.refresh(
      VictorEngine.Parameters.MateriaSystem.AftermathText
    );
