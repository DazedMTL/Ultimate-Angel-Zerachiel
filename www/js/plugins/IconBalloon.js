...
(function () {
  ...
  const parameters = JSON.parse(
    JSON.stringify(
      PluginManager.parameters("IconBalloon"),
      function (key, value) {
        try {
  ...
  MOTIONS["normal"] = MOTIONS["normal"] || [
    ...
    10,
    "scale",
    1.15, //10フレームかけて拡大率を115%に
    5,
    "scale",
    0.9, //5フレームかけて拡大率を90%に
    5,
    "scale",
    1, //5フレームかけて拡大率を100%に
  ];
  MOTIONS["normal_f"] = MOTIONS["normal_f"] || [
    ...
    0,
    "scale",
    0.9, //fs(8フレーム)だけ待機した直後に0フレームで拡大率を90%に
    fs,
    "wait",
    0,
    "scale",
  ...
  MOTIONS["rock"] = MOTIONS["rock"] || [
    ...
    8,
    "scale",
    0.8, //8フレームかけて拡大率を80%に
    8,
    "scale",
    1.15,
    "angle",
    15, //8フレームかけて拡大率を115%に&角度を15度に
    8,
    "scale",
    1,
    "angle",
  ...
  Game_CharacterBase.prototype.requestIconBalloon = function (
    balloonId = 0,
  ...
  const _Sprite_Character_startBalloon =
    Sprite_Character.prototype.startBalloon;
  ...
  Sprite_Balloon.prototype.setupIconSprite = function (iconId) {
    ...
    sprite.setFrame((iconId % 16) * 32, Math.floor(iconId / 16) * 32, 32, 32);
  ...
  Sprite_Balloon.prototype.updateIconMotion = function () {
    ...
    for (; typeof data[i] === "string"; i += 2) {
      ...
      switch (type) {
        ...
        case "scale":
          value =
            d <= 1 ? target : icon.scale.x + (target - icon.scale.x) / (d - 1);
        ...
        case "scalY":
          icon.scale.y =
            d <= 1 ? target : icon.scale.y + (target - icon.scale.y) / (d - 1);
          break;
        case "opacity":
          icon.opacity =
            d <= 1 ? target : icon.opacity + (target - icon.opacity) / (d - 1);
          break;
        case "angle":
          icon.rotation =
            d <= 1
              ? target * ANGLE
              : icon.rotation + (target * ANGLE - icon.rotation) / (d - 1);
          break;
        case "x":
