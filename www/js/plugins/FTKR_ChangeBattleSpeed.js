...
(function () {
  ...
  var getParamVariableValue = function (param, base) {
    return param.variableId
      ? $gameVariables.value(param.variableId)
      : !isNaN(param.initValue)
      ? param.initValue
      : base;
  };
  ...
  var setParamVariableValue = function (param) {
    if (param.variableId)
      $gameVariables.setValue(param.variableId, param.initValue);
  };
  ...
  var _CBS_Window_BattleLog_messageSpeed =
    Window_BattleLog.prototype.messageSpeed;
  Window_BattleLog.prototype.messageSpeed = function () {
    return getParamVariableValue(
      FTKR.CBS.messageSpeed,
      _CBS_Window_BattleLog_messageSpeed.call(this)
    );
  };

  var _CBS_Window_BattleLog_showAnimation =
  ...
  Window_BattleLog.prototype.showAnimation = function (
    ...
    _CBS_Window_BattleLog_showAnimation.call(
      this,
      subject,
      targets,
      animationId
  ...
  var _CBS_Window_BattleLog_showEnemyAttackAnimation =
  ...
  var _CBS_Window_BattleLog_animationBaseDelay =
    Window_BattleLog.prototype.animationBaseDelay;
  Window_BattleLog.prototype.animationBaseDelay = function () {
    var delay =
      this._subject && !this._subject.isActor()
        ? this.animationEnemyDelay()
        : 0;
    return (
      delay +
      getParamVariableValue(
        FTKR.CBS.animationBaseDelay,
        _CBS_Window_BattleLog_animationBaseDelay.call(this)
      )
    );
  };

  var _CBS_Window_BattleLog_animationNextDelay =
    Window_BattleLog.prototype.animationNextDelay;
  Window_BattleLog.prototype.animationNextDelay = function () {
    return getParamVariableValue(
      FTKR.CBS.animationNextDelay,
      _CBS_Window_BattleLog_animationNextDelay.call(this)
    );
  };
  ...
  var _CBS_Sprite_Animation_initMembers =
