...
(function (_) {
        ...
        if (
          window.confirm(
            info[1] +
              ...
              info[2] +
              " " +
              (info[4] ? "v" + String(info[4]) + " or greater " : "") +
  ...
  _.windowSettings["width"] =
    _.params["Screen Resolution"].Width || _.params["Game Resolution"].Width;
  _.windowSettings["height"] =
    _.params["Screen Resolution"].Height || _.params["Game Resolution"].Height;
