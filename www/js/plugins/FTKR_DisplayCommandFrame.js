...
(function () {
  ...
  /*-------------------------------------------------------------
    ...
    -------------------------------------------------------------*/
  Window_Base.prototype.drawDcfFrameBase = function (
    frame,
    rect,
    onCursor,
    item,
  ...
  /*-------------------------------------------------------------
    ...
    -------------------------------------------------------------*/
  Window_Base.prototype.drawImageFrame = function (
    frame,
    rect,
    onCursor,
    item
    ...
    if (image && image.name) {
      ...
      var index =
        frame.changeOnCursor && onCursor
          ? csrIndex || image.csrIndex
  ...
  /*-------------------------------------------------------------
    ...
    -------------------------------------------------------------*/
  Window_Base.prototype.drawLineFrame = function (
    double,
    frame,
    rect,
    onCursor,
    ...
    if (line && line.thick) {
      ...
      var color =
        frame.changeOnCursor && onCursor
          ? csrColor || line.csrColor
          : defColor || line.defColor;
  ...
  Window_Base.prototype.drawInFrame = function (frame, rect, onCursor, item) {
    ...
    if (fill) {
      ...
      var color1 =
        frame.changeOnCursor && onCursor
          ? csrColor || fill.csrColor
          : defColor || fill.defColor;
      var color2 =
        frame.changeOnCursor && onCursor
  ...
  //カーソルサイズに枠線を描画
  Window_Base.prototype.drawLineFrameBase = function (
    rect,
    offset,
    color,
    thick
  ...
  //枠線を描画
  Window_Base.prototype.drawDcfFrameLine = function (
    x,
    y,
    width,
    height,
  ...
  //矩形を描画
  Window_Base.prototype.drawRect = function (
    x,
    y,
    width,
    thick,
  ...
  /*-------------------------------------------------------------
    ...
    -------------------------------------------------------------*/
  Window_Selectable.prototype.drawDcfFrame = function (
    index,
    frame,
    type,
    item
  ...
  var _DCF_Window_TitleCommand_drawItem =
    Window_TitleCommand.prototype.drawItem;
  ...
  var _DCF_Window_ItemCategory_drawItem =
    Window_ItemCategory.prototype.drawItem;
  ...
  var _DCF_Window_EquipCommand_drawItem =
    Window_EquipCommand.prototype.drawItem;
  ...
  var _DCF_Window_PartyCommand_drawItem =
    Window_PartyCommand.prototype.drawItem;
  ...
  var _DCF_Window_ActorCommand_drawItem =
