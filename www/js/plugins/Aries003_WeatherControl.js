...
Aries.P003_WCT.RainAlphaC = Number(
  Aries.P003_WCT.Param["Raindrop Opacity Base"]
);
Aries.P003_WCT.RainAngleV = Number(
  Aries.P003_WCT.Param["Raindrop Angle Variation"]
);
Aries.P003_WCT.RainAlphaV = Number(
  Aries.P003_WCT.Param["Raindrop Opacity Variation"]
);
Aries.P003_WCT.RainSizeV = Number(
  Aries.P003_WCT.Param["Raindrop Size Variation"]
);
...
Aries.P003_WCT.StormMin = Number(
  Aries.P003_WCT.Param["Storm Raindrop Count Minimum"]
);
Aries.P003_WCT.StormMax = Number(
  Aries.P003_WCT.Param["Storm Raindrop Count Maximum"]
);
Aries.P003_WCT.StormLife = Number(
  Aries.P003_WCT.Param["Storm Raindrop Lifetime"]
);
Aries.P003_WCT.StormSpeed = Number(
  Aries.P003_WCT.Param["Storm Raindrop Speed"]
);
Aries.P003_WCT.StormAngleC = Number(
  Aries.P003_WCT.Param["Storm Raindrop Angle Base"]
);
Aries.P003_WCT.StormAlphaC = Number(
  Aries.P003_WCT.Param["Storm Raindrop Opacity Base"]
);
Aries.P003_WCT.StormAngleV = Number(
  Aries.P003_WCT.Param["Storm Raindrop Angle Variation"]
);
Aries.P003_WCT.StormAlphaV = Number(
  Aries.P003_WCT.Param["Storm Raindrop Opacity Variation"]
);
Aries.P003_WCT.StormSizeV = Number(
  Aries.P003_WCT.Param["Storm Raindrop Size Variation"]
);
Aries.P003_WCT.StormDim = Number(
  Aries.P003_WCT.Param["Storm Screen Tone Power"]
);
Aries.P003_WCT.StormTone = eval(
  Aries.P003_WCT.Param["Storm Screen Tone Color"]
);

Aries.P003_WCT.StormThunder = eval(Aries.P003_WCT.Param["Storm Thunder"]);
Aries.P003_WCT.StormThunderB = eval(
  Aries.P003_WCT.Param["Storm Thunder in Battle"]
);
Aries.P003_WCT.ThunderSound = String(Aries.P003_WCT.Param["Thunder Sound"]);
Aries.P003_WCT.ThunderSEVol = Number(
  Aries.P003_WCT.Param["Thunder Sound Volume"]
);
Aries.P003_WCT.ThunderSEPitch = Number(
  Aries.P003_WCT.Param["Thunder Sound Pitch"]
);
Aries.P003_WCT.ThunderSEPitchV = Number(
  Aries.P003_WCT.Param["Thunder Sound Pitch Variation"]
);
Aries.P003_WCT.ThunderWait = Number(Aries.P003_WCT.Param["Thunder Wait Time"]);
Aries.P003_WCT.ThunderWaitV = Number(
  Aries.P003_WCT.Param["Thunder Wait Time Variation"]
);
Aries.P003_WCT.ThunderFlash = Number(
  Aries.P003_WCT.Param["Thunder Flash Power"]
);
Aries.P003_WCT.ThunderFlashV = Number(
  Aries.P003_WCT.Param["Thunder Flash Variation"]
);
...
Aries.P003_WCT.SnowSpeedC = Number(
  Aries.P003_WCT.Param["Snowflake Speed Base"]
);
Aries.P003_WCT.SnowAlphaC = Number(
  Aries.P003_WCT.Param["Snowflake Opacity Base"]
);
Aries.P003_WCT.SnowSpeedV = Number(
  Aries.P003_WCT.Param["Snowflake Speed Variation"]
);
Aries.P003_WCT.SnowAlphaV = Number(
  Aries.P003_WCT.Param["Snowflake Opacity Variation"]
);
Aries.P003_WCT.SnowSizeV = Number(
  Aries.P003_WCT.Param["Snowflake Size Variation"]
);
...
Aries.P003_WCT.LeafSpeedV = Number(
  Aries.P003_WCT.Param["Leaf Speed Variation"]
);
...
Aries.P003_WCT.HeatSpeedV = Number(
  Aries.P003_WCT.Param["Embers Speed Variation"]
);
Aries.P003_WCT.HeatSizeV = Number(
  Aries.P003_WCT.Param["Embers Size Variation"]
);
Aries.P003_WCT.HeatDim = Number(
  Aries.P003_WCT.Param["Embers Screen Tone Power"]
);
Aries.P003_WCT.MysticTone = eval(
  Aries.P003_WCT.Param["Embers Screen Tone Color"]
);
...
Aries.P003_WCT.MysticAlphaC = Number(
  Aries.P003_WCT.Param["Shine Opacity Base"]
);
Aries.P003_WCT.MysticAlphaV = Number(
  Aries.P003_WCT.Param["Shine Opacity Variation"]
);
Aries.P003_WCT.MysticSizeV = Number(
  Aries.P003_WCT.Param["Shine Size Variation"]
);
Aries.P003_WCT.MysticDim = Number(
  Aries.P003_WCT.Param["Shine Screen Tone Power"]
);
Aries.P003_WCT.MysticTone = eval(
  Aries.P003_WCT.Param["Shine Screen Tone Color"]
);
...
Game_Interpreter.prototype.pluginCommand = function (command, args) {
  ...
  if (command === "AriesToggleStormThunder") {
    ...
    Aries.P003_WCT.setWeatherImage(
...
Game_Screen.prototype.clearWeather = function () {
  ...
  this._stormThunderCount =
    4 * (Aries.P003_WCT.ThunderWait + Aries.P003_WCT.ThunderWaitV);
...
Game_Screen.prototype.updateStorm = function () {
  ...
  if (this._stormThunderCount <= 0) {
    var alpha = Math.min(
      Aries.P003_WCT.ThunderFlash -
        Aries.P003_WCT.ThunderFlashV +
        Math.randomInt(1 + Aries.P003_WCT.ThunderFlashV * 2),
      255
    );
    ...
    this._stormThunderCount =
      4 *
      (Aries.P003_WCT.ThunderWait -
        Aries.P003_WCT.ThunderWaitV +
        Math.randomInt(1 + Aries.P003_WCT.ThunderWaitV * 2));
    thunderSound = {
      name: Aries.P003_WCT.ThunderSound,
      pan: 0,
      pitch:
        Aries.P003_WCT.ThunderSEPitch -
        Aries.P003_WCT.ThunderSEPitchV +
        Math.randomInt(1 + Aries.P003_WCT.ThunderSEPitchV * 2),
...
Weather.prototype._updateDimmer = function () {
  ...
  this._dimmerSprite.opacity = Math.floor(
    0.1 * this.power * dimPower * Aries.P003_WCT.DimmerIntensity
  );
};
  ...
  switch (this.type) {
    case "rain":
      ...
      var size =
        0.01 *
        (100 -
          Aries.P003_WCT.RainSizeV +
          Math.randomInt(1 + Aries.P003_WCT.RainSizeV * 2));
      var getangle =
        Aries.P003_WCT.RainAngleC -
        Aries.P003_WCT.RainAngleV +
        Math.randomInt(1 + Aries.P003_WCT.RainAngleV * 2);
      var alpha =
        Aries.P003_WCT.RainAlphaC -
        Aries.P003_WCT.RainAlphaV +
        Math.randomInt(1 + Aries.P003_WCT.RainAlphaV * 2);
    ...
    case "storm":
      ...
      var size =
        0.01 *
        (100 -
          Aries.P003_WCT.StormSizeV +
          Math.randomInt(1 + Aries.P003_WCT.StormSizeV * 2));
      var getangle =
        Aries.P003_WCT.StormAngleC -
        Aries.P003_WCT.StormAngleV +
        Math.randomInt(1 + Aries.P003_WCT.StormAngleV * 2);
      var alpha =
        Aries.P003_WCT.StormAlphaC -
        Aries.P003_WCT.StormAlphaV +
        Math.randomInt(1 + Aries.P003_WCT.StormAlphaV * 2);
    ...
    case "snow":
      ...
      var size =
        0.01 *
        (100 -
          Aries.P003_WCT.SnowSizeV +
          Math.randomInt(1 + Aries.P003_WCT.SnowSizeV * 2));
      var getangle = (-1 + Math.randomInt(3)) * 0.267;
      var alpha =
        Aries.P003_WCT.SnowAlphaC -
        Aries.P003_WCT.SnowAlphaV +
        Math.randomInt(1 + Aries.P003_WCT.SnowAlphaV * 2);
    ...
    case "leaves":
      ...
      var size =
        0.007 *
        (100 -
          Aries.P003_WCT.LeafSizeV +
          Math.randomInt(1 + Aries.P003_WCT.LeafSizeV * 2));
    ...
    case "embers":
      ...
      var size =
        0.007 *
        (100 -
          Aries.P003_WCT.HeatSizeV +
          Math.randomInt(1 + Aries.P003_WCT.HeatSizeV * 2));
    ...
    case "shine":
      ...
      var size =
        0.007 *
        (100 -
          Aries.P003_WCT.MysticSizeV +
          Math.randomInt(1 + Aries.P003_WCT.MysticSizeV * 2));
      var getangle = 12;
      var alpha =
        Aries.P003_WCT.MysticAlphaC -
        Aries.P003_WCT.MysticAlphaV +
        Math.randomInt(1 + Aries.P003_WCT.MysticAlphaV * 2);
...
Weather.prototype._getMaxSpriteCount = function () {
  ...
  switch (this.type) {
    case "rain":
      maxCount =
        Aries.P003_WCT.RainMin + Aries.P003_WCT.RainMax * this.power * 0.1;
      break;
    case "storm":
      maxCount =
        Aries.P003_WCT.StormMin + Aries.P003_WCT.StormMax * this.power * 0.1;
      break;
    case "snow":
      maxCount =
        Aries.P003_WCT.SnowMin + Aries.P003_WCT.SnowMax * this.power * 0.1;
      break;
    case "leaves":
      maxCount =
        Aries.P003_WCT.LeafMin + Aries.P003_WCT.LeafMax * this.power * 0.1;
      break;
    case "embers":
      maxCount =
        Aries.P003_WCT.HeatMin + Aries.P003_WCT.HeatMax * this.power * 0.1;
      break;
    case "shine":
      maxCount =
        Aries.P003_WCT.MysticMin + Aries.P003_WCT.MysticMax * this.power * 0.1;
      break;
  }
  return maxCount;
};
...
Sprite_Weather.prototype.setUp = function (
  type,
  life,
  size,
  getangle,
...
if (Aries.P001_ASE !== undefined) {
  var _aries_p003_spritesetBase_createScreenEffectFilters =
    Spriteset_Base.prototype.createScreenEffectFilters;
  ...
  var _aries_p003_spritesetBase_updateScreenEffects =
    Spriteset_Base.prototype.updateScreenEffects;
    ...
    if (this._wct_glow_filter) {
      switch ($gameScreen.weatherType()) {
        case "rain":
          ...
          this._wct_glow_filter.brightness =
            1 - 0.025 * $gameScreen.weatherPower();
        ...
        case "storm":
          ...
          this._wct_glow_filter.brightness =
            1 - 0.06 * $gameScreen.weatherPower();
          this._wct_glow_filter.blur = 0.2 * $gameScreen.weatherPower();
          this._wct_glow_filter.threshold = 0.075;
          break;
        case "snow":
          this._wct_glow_filter.enabled = true;
          this._wct_glow_filter.bloomScale =
            0.1 + 0.005 * $gameScreen.weatherPower();
          this._wct_glow_filter.brightness =
            1 + 0.001 * $gameScreen.weatherPower();
        ...
        case "embers":
          this._wct_glow_filter.enabled = true;
          this._wct_glow_filter.bloomScale =
            0.2 + 0.015 * $gameScreen.weatherPower();
