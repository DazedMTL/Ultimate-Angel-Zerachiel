...
(function () {
  ...
  var parameters = $plugins.filter(function (p) {
    return p.description.contains("<BattleEffects2>");
  })[0].parameters;
  ...
  Olivia.BattleEffects2.___Game_BattlerBase_refresh___ =
  ...
  Game_BattlerBase.prototype.refreshBattleEffects2Modifiers = function () {
    this._lowHealthBonusModifiers = [
      0,
      0,
      this.returnBattleEffects2NotetagFloat(
        /<(?:Low Health|Enmity) ATK:[ ]([\+\-]\d+)([%％])>/i
      ),
      this.returnBattleEffects2NotetagFloat(
        /<(?:Low Health|Enmity) DEF:[ ]([\+\-]\d+)([%％])>/i
      ),
      this.returnBattleEffects2NotetagFloat(
        /<(?:Low Health|Enmity) MAT:[ ]([\+\-]\d+)([%％])>/i
      ),
      this.returnBattleEffects2NotetagFloat(
        /<(?:Low Health|Enmity) MDF:[ ]([\+\-]\d+)([%％])>/i
      ),
      this.returnBattleEffects2NotetagFloat(
        /<(?:Low Health|Enmity) AGI:[ ]([\+\-]\d+)([%％])>/i
      ),
      this.returnBattleEffects2NotetagFloat(
        /<(?:Low Health|Enmity) LUK:[ ]([\+\-]\d+)([%％])>/i
      ),
    ];
    this._highHealthBonusModifiers = [
      0,
      0,
      this.returnBattleEffects2NotetagFloat(
        /<(?:High Health|Stamina) ATK:[ ]([\+\-]\d+)([%％])>/i
      ),
      this.returnBattleEffects2NotetagFloat(
        /<(?:High Health|Stamina) DEF:[ ]([\+\-]\d+)([%％])>/i
      ),
      this.returnBattleEffects2NotetagFloat(
        /<(?:High Health|Stamina) MAT:[ ]([\+\-]\d+)([%％])>/i
      ),
      this.returnBattleEffects2NotetagFloat(
        /<(?:High Health|Stamina) MDF:[ ]([\+\-]\d+)([%％])>/i
      ),
      this.returnBattleEffects2NotetagFloat(
        /<(?:High Health|Stamina) AGI:[ ]([\+\-]\d+)([%％])>/i
      ),
      this.returnBattleEffects2NotetagFloat(
        /<(?:High Health|Stamina) LUK:[ ]([\+\-]\d+)([%％])>/i
      ),
    ];
  };
  ...
  Game_BattlerBase.prototype.returnBattleEffects2NotetagFloat = function (
    note
  ) {
  ...
  Game_BattlerBase.prototype.returnBattleEffects2NotetagPresent = function (
    note
  ) {
    var objects = this.getBattleEffects2BattlerObjects();
    var modifier = 0;
  ...
  Olivia.BattleEffects2.___Game_BattlerBase_paramRate___ =
    Game_BattlerBase.prototype.paramRate;
  Game_BattlerBase.prototype.paramRate = function (paramId) {
    var rate = Olivia.BattleEffects2.___Game_BattlerBase_paramRate___.call(
      this,
      paramId
    );
    if (paramId >= 2) {
  ...
  Olivia.BattleEffects2.___Game_BattlerBase_param___ =
    Game_BattlerBase.prototype.param;
  Game_BattlerBase.prototype.param = function (paramId) {
    var paramId = this.getSwappedParamID(paramId);
    return Olivia.BattleEffects2.___Game_BattlerBase_param___.call(
      this,
      paramId
    );
  };
  ...
  Olivia.BattleEffects2.___Game_Battler_addState___ =
  ...
  Game_Battler.prototype.isStateDissolve = function (stateId) {
    ...
    for (var i = 0; i < states.length; i++) {
      ...
      if (
        !!state &&
        state.note.match(
          /<(?:Veil|Dissolve) (?:State|States):[ ]*(\d+(?:\s*,\s*\d+)*)>/i
        )
      ) {
  ...
  Olivia.BattleEffects2.___Game_Action_executeHpDamage___ =
    Game_Action.prototype.executeHpDamage;
  Game_Action.prototype.executeHpDamage = function (target, value) {
    value = this.applyDamageCut(target, value);
    Olivia.BattleEffects2.___Game_Action_executeHpDamage___.call(
      this,
      target,
      value
    );
  ...
  Olivia.BattleEffects2.___Sprite_Damage_setupCriticalEffect___ =
  ...
  Olivia.BattleEffects2.___Sprite_Damage_createDigits___ =
    Sprite_Damage.prototype.createDigits;
  Sprite_Damage.prototype.createDigits = function (baseRow, value) {
    value = Math.floor(value);
    var start = this.children.length;
    Olivia.BattleEffects2.___Sprite_Damage_createDigits___.call(
      this,
      baseRow,
      value
    );
  ...
  Olivia.BattleEffects2.___Sprite_Damage_update___ =
    Sprite_Damage.prototype.update;
  ...
  Olivia.BattleEffects2.___Sprite_Damage_updateChild___ =
  ...
  Olivia.BattleEffects2.___Window_Base_drawGauge___ =
    Window_Base.prototype.drawGauge;
  Window_Base.prototype.drawGauge = function (
    ...
    rate = rate.clamp(0, 1);
    Olivia.BattleEffects2.___Window_Base_drawGauge___.call(
      this,
      x,
      y,
      width,
