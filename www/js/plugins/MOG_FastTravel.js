...
// ** DUNGEONS
//=============================================================================	
Moghunter.fastTravelDungeons[1] = { name: "神護の森", x: 1945, y: 1090, mapID: 159, mapX: 40, mapY: 1, direction: 2 };
Moghunter.fastTravelDungeons[2] = { name: "幻獣の森", x: 1642, y: 750, mapID: 129, mapX: 23, mapY: 25, direction: 8 };
Moghunter.fastTravelDungeons[3] = { name: "熱砂の砂漠", x: 680, y: 578, mapID: 161, mapX: 49, mapY: 60, direction: 8 };
Moghunter.fastTravelDungeons[4] = { name: "星詠みの森", x: 1064, y: 565, mapID: 121, mapX: 20, mapY: 78, direction: 8 };
Moghunter.fastTravelDungeons[5] = { name: "魔鉱山", x: 2478, y: 1115, mapID: 114, mapX: 12, mapY: 22, direction: 8 };
Moghunter.fastTravelDungeons[6] = { name: "聖域へ続く道", x: 925, y: 480, mapID: 140, mapX: 38, mapY: 31, direction: 4 };

//=============================================================================
// ** OTHER
//=============================================================================	
Moghunter.fastTravelOther[1] = { name: "記憶の断片", x: 1304, y: 1280, mapID: 123, mapX: 14, mapY: 23, direction: 8 };
Moghunter.fastTravelOther[2] = { name: "夢幻の大樹", x: 1048, y: 400, mapID: 226, mapX: 15, mapY: 25, direction: 8 };
Moghunter.fastTravelOther[3] = { name: "森林の秘境", x: 1048, y: 400, mapID: 74, mapX: 2, mapY: 7, direction: 6 };
Moghunter.fastTravelOther[4] = { name: "砂漠の秘境", x: 1048, y: 400, mapID: 87, mapX: 2, mapY: 7, direction: 6 };
Moghunter.fastTravelOther[5] = { name: "渓谷の秘境", x: 1048, y: 400, mapID: 139, mapX: 2, mapY: 7, direction: 6 };
Moghunter.fastTravelOther[6] = { name: "炎山の秘境", x: 1048, y: 400, mapID: 222, mapX: 2, mapY: 7, direction: 6 };
Moghunter.fastTravelOther[7] = { name: "雪原の秘境", x: 1048, y: 400, mapID: 223, mapX: 2, mapY: 7, direction: 6 };
Moghunter.fastTravelOther[8] = { name: "夢幻の秘境", x: 1048, y: 400, mapID: 223, mapX: 2, mapY: 7, direction: 6 };
