...
if (Imported.SoR_PartyCommandHUD)
  throw new Error(
    "[SoR_PartyCommandHUD_MZ] Do NOT import more than 2 types of <SoR_PartyCommandHUD> series."
  );
...
(function () {
  ...
  const IsActorStatusPositionAdjust =
    Boolean(Param["IsActorStatusPositionAdjust"] === "true") || false;
  const IsActorStatusPositionFixed =
    Boolean(Param["IsActorStatusPositionFixed"] === "true") || false;
  const PartyCommandWindow_Yratio = Number(
    Param["PartyCommandWindow_Y-ratio"] || 1.0
  );
  const PartyCommandWindow_width = Number(
    Param["PartyCommandWindow_width"] || 400
  );
  ...
  Scene_Battle.prototype.partyCommandWindowRect = function () {
    ...
    const y =
      ...
      Window_PartyCommand.prototype.fittingHeight() * PartyCommandWindow_Yratio;
  ...
  Window_PartyCommand.prototype.fittingHeight = function () {
    return (
      this.numVisibleRows() * this.itemHeight() +
