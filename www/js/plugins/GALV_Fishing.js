...
(function () {
  var txt = "";
  Galv.FISH.surfaceY = Number(
    PluginManager.parameters("GALV_Fishing")["Surface Y"]
  );
  ...
  txt =
    PluginManager.parameters("GALV_Fishing")["Fisher Rod XY Offset"].split(",");
  Galv.FISH.rodInfo = {
    x: Number(txt[0]),
    y: Number(txt[1]),
    dir: txt[2] || "left",
  ...
  Galv.FISH.hookedAnim = Number(
    PluginManager.parameters("GALV_Fishing")["Hooked Anim"]
  );
  Galv.FISH.breakAnim = Number(
    PluginManager.parameters("GALV_Fishing")["Break Anim"]
  );
  Galv.FISH.pCatchAnim = Number(
    PluginManager.parameters("GALV_Fishing")["Player Catch Anim"]
  );

  // END SOUND OBJECTS

  Galv.FISH.splashImg =
    PluginManager.parameters("GALV_Fishing")["Splash Graphic"];
  Galv.FISH.splashFrames = 5;

  Galv.FISH.baitImg =
    PluginManager.parameters("GALV_Fishing")["Default Bait Graphic"];
  Galv.FISH.baitFrames = 4;

  Galv.FISH.powImg =
    PluginManager.parameters("GALV_Fishing")["Cast Power Graphic"];
  Galv.FISH.powFrames =
    PluginManager.parameters("GALV_Fishing")["Cast Power Frames"];

  Galv.FISH.rodImg =
    PluginManager.parameters("GALV_Fishing")["Default Rod Graphic"];

  Galv.FISH.fishFrames = 4;

  Galv.FISH.equipSlot =
    PluginManager.parameters("GALV_Fishing")["Equip Slot Graphic"];
  Galv.FISH.noRodTxt = PluginManager.parameters("GALV_Fishing")["No Rod Text"];
  Galv.FISH.noBaitTxt =
    PluginManager.parameters("GALV_Fishing")["No Bait Text"];

  Galv.FISH.noTxtSize = Number(
    PluginManager.parameters("GALV_Fishing")["No RodBait Text Size"]
  );

  Galv.FISH.castText = PluginManager.parameters("GALV_Fishing")["Cast Text"];
  Galv.FISH.equipRodText =
    PluginManager.parameters("GALV_Fishing")["Equip Rod Text"];
  Galv.FISH.equipBaitText =
    PluginManager.parameters("GALV_Fishing")["Equip Bait Text"];
  Galv.FISH.leaveText = PluginManager.parameters("GALV_Fishing")["Leave Text"];
  Galv.FISH.caughtText =
    PluginManager.parameters("GALV_Fishing")["Caught Text"];

  Galv.FISH.eWinWidth = Number(
    PluginManager.parameters("GALV_Fishing")["Equip Window Width"]
  );
  Galv.FISH.eWinCols = Number(
    PluginManager.parameters("GALV_Fishing")["Equip Window Cols"]
  );
  ...
  Galv.FISH.rFishNumber =
    PluginManager.parameters("GALV_Fishing")["Record Fish Number"];
  Galv.FISH.rFishLength =
    PluginManager.parameters("GALV_Fishing")["Record Fish Length"];
  Galv.FISH.rFishWeight =
    PluginManager.parameters("GALV_Fishing")["Record Fish Weight"];
  Galv.FISH.rPadding = Number(
    PluginManager.parameters("GALV_Fishing")["Record Scene Padding"]
  );

  Galv.FISH.rFishPosY = Number(
    PluginManager.parameters("GALV_Fishing")["Record Fish Y"]
  );
  Galv.FISH.rFishScale = Number(
    PluginManager.parameters("GALV_Fishing")["Record Fish Scale"]
  );
  ...
  Galv.FISH.loseBaitOnCatch =
    PluginManager.parameters("GALV_Fishing")["Lose Bait"].toLowerCase() ==
    "true";
  ...
  Galv.FISH.addRecords = function (fishId, length, weight) {
    if (Galv.FISH.fish[fishId].stats) {
      $gameSystem.fishing.caught[fishId] = $gameSystem.fishing.caught[
        fishId
      ] || { id: fishId, amount: 0, length: 0, weight: 0 };
      $gameSystem.fishing.caught[fishId].amount += 1;
      $gameSystem.fishing.caught[fishId].length = Math.max(
        length,
        $gameSystem.fishing.caught[fishId].length
      );
      $gameSystem.fishing.caught[fishId].weight = Math.max(
        weight,
        $gameSystem.fishing.caught[fishId].weight
      );
  ...
  Galv.FISH.checkEquips = function (fisher) {
    ...
    if (rodId && $gameParty.numItems($dataItems[rodId]) <= 0)
      fisher._rodEquipped = null;
    var baitId = fisher._baitEquipped;
    if (baitId && $gameParty.numItems($dataItems[baitId]) <= 0)
      fisher._baitEquipped = null;
  };
  ...
  Galv.FISH.data = function (id, data) {
    ...
    if (data == "name") {
      return data.item
        ? $dataItems[Galv.FISH.fish[id].item].name
        : data.graphic;
    }
    return $gameSystem.fishing.caught[id]
      ? $gameSystem.fishing.caught[id][data]
      : 0;
  };
  ...
  Game_System.prototype.initialize = function () {
    ...
    this.fishing = {
      ...
      hole: {
        // settings for current fishing hole (fish, music, background, etc.)
        bg: "back1",
        surface: "surface1",
        under: "under1",
...
Scene_Fishing.prototype.endScene = function () {
  ...
  if (Galv.FISH.commonEvent)
    $gameTemp.reserveCommonEvent(Galv.FISH.commonEvent);
};
...
Scene_Fishing.prototype.updateIdleFishing = function () {
  if (Galv.FISH.bait) {
    if (
      ...
      if (
        Galv.FISH.bait.x >= Galv.FISH.pond._endX &&
        Galv.FISH.bait.y <= Galv.FISH.pond._surfaceY
      )
        this.cancelFishing();
    } else {
      // sinking
      ...
      // sink movement
      Galv.FISH.bait.y = Math.min(
        Galv.FISH.bait.y + Galv.FISH.bait.weight,
        Galv.FISH.pond._floor
      );
    }
  }
};
...
Scene_Fishing.prototype.testLine = function (fish) {
  if (
    (Galv.FISH.fisher.reeling && fish.dir < 0) ||
    (Galv.FISH.fisher.reeling && fish._moveType <= 0)
  ) {
...
Scene_Fishing.prototype.castingSet = function () {
  ...
  this._dist =
    Galv.FISH.pond.width - rate * Galv.FISH.pond.width + Galv.FISH.pond.x;
};
...
Scene_Fishing.prototype.createBait = function () {
  Galv.FISH.bait = {
    ...
    weight:
      Number($dataItems[Galv.FISH.fisher._baitEquipped].meta.baitSink) || 1,
...
Spriteset_Fishing.prototype.initialize = function () {
...
Spriteset_Fishing.prototype.createBackground = function () {
  ...
  this._bgLayer.bitmap = ImageManager.loadFishGraphic(
    $gameSystem.fishing.hole.bg
  );
  ...
  this._undLayer.bitmap = ImageManager.loadFishGraphic(
    $gameSystem.fishing.hole.under
  );
  this._undLayer.z = -99;
  ...
  this._undOLayer.bitmap = ImageManager.loadFishGraphic(
    $gameSystem.fishing.hole.underOverlay
  );
  ...
  this._surLayer.bitmap = ImageManager.loadFishGraphic(
    $gameSystem.fishing.hole.surface
  );
  this._surLayer.move(
    0,
    $gameSystem.fishing.hole.surfaceY,
    Graphics.boxWidth,
    170
  );
  this._surLayer.z = -89;
  ...
  this._lanLayer.bitmap = ImageManager.loadFishGraphic(
    $gameSystem.fishing.hole.land
  );
  this._lanLayer.z = -88;
...
Sprite_Rod.prototype.setBitmap = function () {
  if (Galv.FISH.fisher._rodEquipped) {
    var img =
      $dataItems[Galv.FISH.fisher._rodEquipped].meta.rodImg || Galv.FISH.rodImg;
  } else {
    var img = "";
  }
...
Sprite_Rod.prototype.updateFrame = function () {
  ...
  if (this._ticker >= this._tickSpeed) {
    Galv.FISH.fisher.rodPat =
      Galv.FISH.fisher.rodPat == this._maxPattern
        ? 0
        : Galv.FISH.fisher.rodPat + 1;
    this._ticker = 0;
  }
};
Sprite_Rod.prototype.patternWidth = function () {
  return this.bitmap.width / 4;
};
Sprite_Rod.prototype.patternHeight = function () {
...
Sprite_CastPow.prototype.updateFrame = function () {
  ...
  this._pattern = Math.min(
    Math.floor(this._maxPattern * this._rate),
    this._maxPattern
  );
};
...
Sprite_CastPow.prototype.patternWidth = function () {
  return this.bitmap.width / Galv.FISH.powFrames;
};
Sprite_CastPow.prototype.patternHeight = function () {
...
Sprite_FishSplash.prototype.patternWidth = function () {
  return this.bitmap.width / Galv.FISH.splashFrames;
};
Sprite_FishSplash.prototype.patternHeight = function () {
  return this.bitmap.height;
};
...
Sprite_FishBait.prototype.setBitmap = function () {
  if (Galv.FISH.fisher._baitEquipped) {
    var img =
      $dataItems[Galv.FISH.fisher._baitEquipped].meta.baitImg ||
      Galv.FISH.baitImg;
  } else {
    var img = "";
  }
...
Sprite_FishBait.prototype.patternWidth = function () {
  return this.bitmap.width / Galv.FISH.baitFrames;
};
Sprite_FishBait.prototype.patternHeight = function () {
  return this.bitmap.height;
};
...
Sprite_FishEquipIcon.prototype.changeBitmap = function () {
  if (this._type == "rod") {
    ...
    this._iconIndex = Galv.FISH.fisher._rodEquipped
      ? $dataItems[Galv.FISH.fisher._rodEquipped].iconIndex
      : 0;
  } else {
    var obj = Galv.FISH.baitXY;
    this._iconIndex = Galv.FISH.fisher._baitEquipped
      ? $dataItems[Galv.FISH.fisher._baitEquipped].iconIndex
      : 0;
  }
...
Sprite_Fish.prototype.patternWidth = function () {
  return this.bitmap.width / Galv.FISH.fishFrames;
};
Sprite_Fish.prototype.patternHeight = function () {
  return this.bitmap.height;
};
...
Window_FishEquip.prototype.maxCols = function () {
  return Galv.FISH.eWinCols;
};
Window_FishEquip.prototype.spacing = function () {
  return 8;
};
...
Window_FishDisplay.prototype.initialize = function () {
  ...
  this.opacity = 0;
  this._equipped = [
    Galv.FISH.fisher._rodEquipped,
    Galv.FISH.fisher._baitEquipped,
  ];
  this.createIcons();
  this.refresh();
};
...
Game_Fish.prototype.outOfPos = function () {
  ...
  if (
    this.y < Galv.FISH.pond._surfaceY + 10 ||
    this.y > Galv.FISH.pond._floor + 10
  )
    return true;
  return false;
};
...
Game_Fish.prototype.isNear = function (range) {
  ...
  if (this._baits.contains(Galv.FISH.bait.id)) {
    return (
      this.dist(Galv.FISH.bait.x, Galv.FISH.bait.y, this.x, this.y) <= range
    );
  } else {
    return false;
  }
...
Scene_FishRecords.prototype.createFishStatusWindow = function () {
  ...
  var wh =
    Graphics.boxHeight -
    this._totalWindow.height -
    Galv.FISH.rPadding * 2 -
    this._titleWindow.height;
...
Scene_FishRecords.prototype.createFishItemWindow = function () {
  var wy =
    this._titleWindow.y + this._titleWindow.height + this._typeWindow.height;
  var wh =
    Graphics.boxHeight -
    this._totalWindow.height -
    Galv.FISH.rPadding * 2 -
    this._titleWindow.height -
    this._recordWindow.height;
...
Window_FishInfo.prototype.type = function () {
  this.resetTextColor();
  var tn = Object.keys($gameSystem.fishing.caught).map(function (key) {
    return $gameSystem.fishing.caught[key];
  }).length;
...
Window_FishRecordList.prototype.makeItemList = function () {
  this._data = Object.keys($gameSystem.fishing.caught).map(function (key) {
    return $gameSystem.fishing.caught[key];
  });
};
