...
(function () {
  ...
  var rx_t_spbp151026_updateBattleback =
    Spriteset_Battle.prototype.updateBattleback;
  Spriteset_Battle.prototype.updateBattleback = function () {
    rx_t_spbp151026_updateBattleback.call(this);
    if ($gameParty.inBattle() && $gameTemp._rx_changeBatBack_in_battle) {
      if (
        this.battleback1Bitmap().isReady() &&
        this.battleback2Bitmap().isReady()
      ) {
        $gameTemp._rx_changeBatBack_in_battle = false;
        if (
          (this._back1Sprite.bitmap || this._back2Sprite.bitmap) &&
          Graphics.isWebGL() != true
        ) {
