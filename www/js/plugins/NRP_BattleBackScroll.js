...
(function () {
  ...
  const pBattleback1SettingList = parseStruct2(
    parameters["Battleback1SettingList"]
  );
  const pBattleback2SettingList = parseStruct2(
    parameters["Battleback2SettingList"]
  );
  ...
  Spriteset_Battle.prototype.updateBattleback = function () {
    ...
    if (this._battleBack1ScrollSetting) {
      ...
      if (this._battleBack1ScrollSetting.speedXVariable) {
        this._back1Sprite.origin.x += $gameVariables.value(
          this._battleBack1ScrollSetting.speedXVariable
        );
      ...
      if (this._battleBack1ScrollSetting.speedYVariable) {
        this._back1Sprite.origin.y += $gameVariables.value(
          this._battleBack1ScrollSetting.speedYVariable
        );
    ...
    if (this._battleBack2ScrollSetting) {
      ...
      if (this._battleBack2ScrollSetting.speedXVariable) {
        this._back2Sprite.origin.x += $gameVariables.value(
          this._battleBack2ScrollSetting.speedXVariable
        );
      ...
      if (this._battleBack2ScrollSetting.speedYVariable) {
        this._back2Sprite.origin.y += $gameVariables.value(
          this._battleBack2ScrollSetting.speedYVariable
        );
  ...
  function getMatchSetting1(battleback1Name) {
    return pBattleback1SettingList.find(
      (setting) => setting.battleback1 == battleback1Name
    );
  }
  ...
  function getMatchSetting2(battleback2Name) {
    return pBattleback2SettingList.find(
      (setting) => setting.battleback2 == battleback2Name
    );
  }
})();
