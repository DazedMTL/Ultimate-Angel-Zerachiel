...
(function (exports) {
  ...
  Window_Message.prototype.doesContinue = function () {
    return (
      _Window_Message_doesContinue.call(this) && !$gameMessage.enemyNameMode()
    );
  };
  ...
  exports.Window_EnemyName = (function () {
    ...
    Window_EnemyName.prototype.fittingHeight = function (numLines) {
      return (
        Window_EnemyName.MESSAGE_POS_Y +
        numLines * (this.lineHeight() + exports.Param.LineSpace)
      );
    };
    ...
    Window_EnemyName.prototype.refresh = function () {
      ...
      if (this._showNames.length > 0) {
        ...
        this._showNames.forEach(function (text, idx) {
          ...
          var y =
            Window_EnemyName.MESSAGE_POS_Y +
            (lineHeight + exports.Param.LineSpace) * idx;
