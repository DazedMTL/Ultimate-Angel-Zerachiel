...
(function () {
  ...
  const pUpdateCursorPosition = toBoolean(
    parameters["UpdateCursorPosition"],
    false
  );
   ...
   * ●タッチ操作
   */
  const _Window_BattleEnemy_processTouch =
   ...
   * ●タッチ操作
   */
  const _Window_BattleActor_processTouch =
  ...
  // MV
  if (Utils.RPGMAKER_NAME == "MV") {
    Window_BattleEnemyName.prototype.initialize = function (
      x,
      y,
      parentWindow
    ) {
  ...
  if (pUpdateCursorPosition) {
    ...
    Window_BattleEnemyName.prototype.update = function () {
      ...
      if (this.visible) {
        ...
        !pShowTargetEnemyName &&
        this._index != null &&
        this._parentWindow._index == this._index
      ) {
        this.showTargetName();
      }
    };
  ...
  // MV
  if (Utils.RPGMAKER_NAME == "MV") {
    Window_BattleActorName.prototype.initialize = function (
      x,
      y,
      parentWindow
    ) {
