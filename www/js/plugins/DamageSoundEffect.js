...
(function () {
  ...
  var param = (function () {
    ...
    var playEnemyConditions = getCustomParam.getConditions(
      originalParam.playEnemySe
    );
    var playActorConditions = getCustomParam.getConditions(
      originalParam.playActorSe
    );
    ...
    var messageEnemyRecovery = getParamString(
      originalParam.messageEnemyRecovery
    );
    var messageActorRecovery = getParamString(
      originalParam.messageActorRecovery
    );
  ...
  /** ダメージ用メッセージを追加 */
  var _Window_BattleLog_makeHpDamageText =
