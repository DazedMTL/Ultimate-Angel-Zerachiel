...
(function () {
  ...
  var paramWindowHeight = getParamNumber(
    ["WindowHeight", "ウィンドウ高さ加算値"],
    0
  );
  var paramCommandF3Name = getParamString(["CommandF3Name", "伸縮モード名称"]);
  var paramCommandF4Name = getParamString([
    "CommandF4Name",
    "全画面モード名称",
  ]);
  ...
  SceneManager.normalMenuCommands = [
    {
      code: 102,
      key: "F3",
      valid: paramCommandF3,
      name: paramCommandF3Name,
      order: 0,
    },
    {
      code: 103,
      key: "F4",
      valid: paramCommandF4,
      name: paramCommandF4Name,
      order: 0,
    },
    {
      code: 104,
      key: "F5",
      valid: paramCommandF5,
      name: paramCommandF5Name,
      order: 0,
    },
  ];
  ...
  SceneManager.addMenuItem = function (menu) {
    ...
    this._menuCommands.forEach(function (commandInfo) {
      ...
      var menuItem = new gui.MenuItem({
        label:
          commandInfo.name +
          (commandInfo.key ? "(" + commandInfo.key + ")" : ""),
      });
