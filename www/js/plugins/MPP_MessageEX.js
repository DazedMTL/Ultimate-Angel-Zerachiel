...
(() => {
  ...
  Window_Message.prototype.resetFontSettings = function () {
    ...
    const outlineColor = `rgba(${getDefaultParam(
      "Outline Color",
      "0, 0, 0, 0.5"
    )})`;
  ...
  Window_Message.prototype.processEscapeCharacter = function (code, textState) {
    switch (code) {
      ...
      case "RC":
        const rubyRgb = getDefaultParam("Ruby Color");
        const rubyColor = rubyRgb
          ? `rgb(${rubyRgb})`
          : getTextColor.call(this, 0);
  ...
  Window_Message.prototype.processNormalCharacterForAnimation = function (
    textState
  ) {
    const list = this.getAnimationList();
  ...
  Window_Message.prototype.processDrawIconForAnimation = function (
    iconIndex,
    textState
  ) {
    const pw = Window_Base._iconWidth || ImageManager.iconWidth;
  ...
  Window_Message.prototype.processGroupCharacterForAnimation = function (
    textState,
    texts
  ) {
    const c = texts[0];
