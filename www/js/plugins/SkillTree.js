...
const SkillTreeClassAlias = (() => {
  ...
  class SkillTreeNode {
    ...
    isOpenable() {
      return (
        this.isSelectable() && !this.isOpened() && this.canCostConsumption()
      );
    }
  ...
  class Window_NodeOpen extends Window_Command {
    ...
    refresh() {
      ...
      this.drawText(
        NodeOpenConfirmationText.format(needSp, SpName, skillName),
        0,
        0,
        textWidth,
        "left"
