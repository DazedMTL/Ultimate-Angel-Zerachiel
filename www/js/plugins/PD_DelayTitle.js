...
(function () {
  ...
  var endFrame = Math.max(
    delayBG1 + fadeBG1,
    delayBG2 + fadeBG2,
    delayTitle + fadeTitle,
    delayCommand
  );
  ...
  Scene_Title.prototype.create = function () {
    ...
    this._whiteSprite = new Sprite(
      ImageManager.reserveBitmap("img/pictures/", "white", 0, true)
    );
    this.addChild(this._whiteSprite);
    this._whiteSprite.addAnimation(
      new QueueTweenAnimation(
        new Point(0, 0),
        new Point(1, 1),
        0,
        0,
    ...
    this._gameTitleSprite.addAnimation(
      new QueueTweenAnimation(
  ...
  Scene_Title.prototype.update = function () {
    ...
    //スキップ
    if (
      (Input.isTriggered("ok") || TouchInput.isPressed()) &&
  ...
  Scene_Title.prototype.createForeground = function () {
    ...
    this._gameTitleSprite = new Sprite(
      ImageManager.reserveBitmap("img/pictures/", "gamelogo_1", 0, true)
    );
    this._gameTitleSprite.opacity = 0;
