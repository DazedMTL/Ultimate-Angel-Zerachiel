...
(function () {
  ...
  var zz_MA_WeekPointView_Scene_Boot_loadSystemImages =
    Scene_Boot.loadSystemImages;
  Scene_Boot.loadSystemImages = function () {
    zz_MA_WeekPointView_Scene_Boot_loadSystemImages.call(this);
    if (weekPointView.textMode) {
      mano_weekPointView_Image.week = createTextBitmap(
        weekPointView.WeekText,
        weekPointView.WeekTextColor
      );
      mano_weekPointView_Image.resistance = createTextBitmap(
        weekPointView.ResistanceText,
        weekPointView.ResistanceTextColor
      );
      mano_weekPointView_Image.Block = createTextBitmap(
        weekPointView.BlockText,
        weekPointView.BlockTextColor
      );
      if (weekPointView.AbsorbText) {
        mano_weekPointView_Image.Avsorb = createTextBitmap(
          weekPointView.AbsorbText,
          weekPointView.AbsorbTextColor
        );
      }
    } else {
      mano_weekPointView_Image.week = ImageManager.loadSystem(
        weekPointView.WeekText
      );
      mano_weekPointView_Image.resistance = ImageManager.loadSystem(
        weekPointView.ResistanceText
      );
      mano_weekPointView_Image.Block = ImageManager.loadSystem(
        weekPointView.BlockText
      );
      if (weekPointView.AbsorbText) {
        mano_weekPointView_Image.Avsorb = ImageManager.loadSystem(
          weekPointView.AbsorbText
        );
      }
    }
  ...
  WeekPointView_Sprite.prototype.updatePosition = function () {
    this.x =
      weekPointView.axisX + this.battler().weekPointView_X() + this._slideX;
  ...
  // Game_Battler                            //
  //-----------------------------------------//
  var zz_MA_WeekPointView_Game_Battler_initMembers =
  ...
  var zz_MA_Spriteset_Battle_UpperLayer =
  ...
  // Window_BattleEnemy                      //
  //-----------------------------------------//
  var zz_MA_WeekPointView_Window_BattleEnemy_select =
  ...
  var zz_MA_WeekPointView_Scene_Battle_commandAttack =
  ...
  var zz_MA_WeekPointView_Scene_Battle_onSelectAction =
  ...
  var zz_MA_WeekPointView_Scene_Battle_startActorCommandSelection =
  ...
  var zz_MA_WeekPointView_Scene_Battle_onEnemyOk =
  ...
  var zz_MA_WeekPointView_Scene_Battle_onEnemyCancel =
