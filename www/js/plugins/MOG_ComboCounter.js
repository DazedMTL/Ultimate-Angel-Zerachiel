...
Moghunter.combo_hit_layout_x = Number(
  Moghunter.parameters["C HIT Layout X-Axis"] || 118
);
Moghunter.combo_hit_layout_y = Number(
  Moghunter.parameters["C HIT Layout Y-Axis"] || 124
);
Moghunter.combo_dmg_layout_x = Number(
  Moghunter.parameters["C DMG Layout X-Axis"] || 10
);
Moghunter.combo_dmg_layout_y = Number(
  Moghunter.parameters["C DMG Layout Y-Axis"] || 90
);
Moghunter.combo_hit_number_x = Number(
  Moghunter.parameters["C HIT Number X-Axis"] || 115
);
Moghunter.combo_hit_number_y = Number(
  Moghunter.parameters["C HIT Number Y-Axis"] || 135
);
Moghunter.combo_dmg_number_x = Number(
  Moghunter.parameters["C DMG Number X-Axis"] || 150
);
Moghunter.combo_dmg_number_y = Number(
  Moghunter.parameters["C DMG Number Y-Axis"] || 93
);
...
// * Game Action
//==============================
var _mog_comboCounterGaction_executeHpDamage =
...
// ** create Spriteset
//==============================
var _mog_comboCounter_sbattle_createSpriteset =
...
HitCounterSprites.prototype.update = function () {
  ...
  if ($gameTemp.combo_data[0]) {
    this.refresh_combo_sprite();
  }
  this.updateOpacity();
  this.updateLayout();
  this.updateNumber1();
  this.updateNumber2();
  if (this.needUpdateDuration()) {
    this.updateDuration();
  }
};
...
HitCounterSprites.prototype.updateLayout = function () {
  this.combo_sprite_a.x =
    this.combo_sprite_data[3] + Moghunter.combo_hit_layout_x;
  this.combo_sprite_a.y = Moghunter.combo_hit_layout_y;
  this.combo_sprite_b.x =
    this.combo_sprite_data[3] + Moghunter.combo_dmg_layout_x;
...
HitCounterSprites.prototype.updateNumber1 = function () {
  for (var i = 0; i < this.combo_sprite_n1.length; i++) {
    this.combo_sprite_n1[i].x =
      this.combo_sprite_data[3] +
      this.combo_sprite_data[1][i] +
      Moghunter.combo_hit_number_x;
    this.combo_sprite_n1[i].y = Moghunter.combo_hit_number_y;
    if (this.combo_sprite_n1[i].scale.x > 1.0) {
    ...
    if (this.combo_sprite_data[0] <= 0) {
      this.combo_sprite_n1[i].opacity -= 10;
    }
  }
};
...
HitCounterSprites.prototype.updateNumber2 = function () {
  for (var i = 0; i < this.combo_sprite_n2.length; i++) {
    this.combo_sprite_n2[i].x =
      this.combo_sprite_data[3] +
      this.combo_sprite_data[2][i] +
      Moghunter.combo_dmg_number_x;
    this.combo_sprite_n2[i].y = Moghunter.combo_dmg_number_y;
    if (this.combo_sprite_data[0] <= 0) {
      this.combo_sprite_n2[i].opacity -= 10;
    }
  }
};
...
HitCounterSprites.prototype.updateDuration = function () {
  if (!$gameTemp.combo_data[4]) {
    this.combo_sprite_data[0] -= 1;
  }
  if ($gameTemp.combo_data[3]) {
    this.combo_sprite_data[0] = 0;
  }
  if (this.combo_sprite_data[0] == 0) {
    $gameTemp.combo_data = [false, 0, 0, false, false];
...
HitCounterSprites.prototype.refresh_combo_hit = function () {
  ...
  for (var i = 0; i < this.combo_sprite_n1.length; i++) {
    this.removeChild(this.combo_sprite_n1[i]);
  }
...
HitCounterSprites.prototype.refresh_combo_damage = function () {
  ...
  for (var i = 0; i < this.combo_sprite_n2.length; i++) {
    this.removeChild(this.combo_sprite_n2[i]);
  }
  for (var i = 0; i < dmg_number.length; i++) {
    var n = Number(dmg_number[i]);
