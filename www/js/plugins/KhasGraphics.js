...
// * Spriteset Battle
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
Spriteset_Battle.prototype.kg_createLowerLayer =
...
// * Spriteset Map
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
Spriteset_Map.prototype.kg_createWeather =
...
Khas_Filter.prototype.copyUniforms = function (filter) {
  for (var uniform in filter.uniforms) {
    if (
      filter.uniforms.hasOwnProperty(uniform) &&
      this.uniforms.hasOwnProperty(uniform)
    )
